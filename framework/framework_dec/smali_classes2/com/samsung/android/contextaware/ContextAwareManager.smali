...
.method public final setCAProperty(IID)Z
    ...
    new-instance v2, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;

    invoke-direct {v2}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;-><init>()V

    invoke-virtual {v2}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->getDoubleTypeCode()I
    ...
    invoke-virtual {v2, v4, v5}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->setValue(ILjava/lang/Object;)V

    invoke-direct {p0, p1, p2, v2}, Lcom/samsung/android/contextaware/ContextAwareManager;->setCAProperty(IILcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;)Z
    ...
    const-string/jumbo v5, "setProperty value changed : "
...
.method public final setCAProperty(IIF)Z
    ...
    new-instance v1, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;

    invoke-direct {v1}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;-><init>()V

    invoke-virtual {v1}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->getFloatTypeCode()I
    ...
    invoke-virtual {v1, v3, v4}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->setValue(ILjava/lang/Object;)V

    invoke-direct {p0, p1, p2, v1}, Lcom/samsung/android/contextaware/ContextAwareManager;->setCAProperty(IILcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;)Z
    ...
    const-string/jumbo v4, "setProperty value changed : "
...
.method public final setCAProperty(III)Z
    ...
    invoke-virtual {v1}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->getIntegerTypeCode()I
...
.method public final setCAProperty(IIJ)Z
    ...
    invoke-virtual {v2}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->getLongTypeCode()I
...
.method public final setCAProperty(IILjava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->getStringTypeCode()I

    move-result v3

    invoke-virtual {v1, v3, p3}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->setValue(ILjava/lang/Object;)V
...
.method public final setCAProperty(IIZ)Z
    ...
    invoke-virtual {v1}, Lcom/samsung/android/contextaware/manager/ContextAwarePropertyBundle;->getBooleanTypeCode()I
