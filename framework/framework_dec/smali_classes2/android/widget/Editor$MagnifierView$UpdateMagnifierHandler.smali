...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get7(Landroid/widget/Editor$MagnifierView;)F
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get4(Landroid/widget/Editor$MagnifierView;)F
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get3(Landroid/widget/Editor$MagnifierView;)[I
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get11(Landroid/widget/Editor$MagnifierView;)I
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get6(Landroid/widget/Editor$MagnifierView;)I
    ...
    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get10(Landroid/widget/Editor$MagnifierView;)[F
    ...
    invoke-static {v3}, Landroid/widget/Editor$MagnifierView;->-get9(Landroid/widget/Editor$MagnifierView;)[F
    ...
    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get11(Landroid/widget/Editor$MagnifierView;)I
    ...
    invoke-static {v1}, Landroid/widget/Editor$MagnifierView;->-get5(Landroid/widget/Editor$MagnifierView;)Landroid/content/Context;

    move-result-object v1

    iget-object v2, p0, Landroid/widget/Editor$MagnifierView$UpdateMagnifierHandler;->this$1:Landroid/widget/Editor$MagnifierView;

    invoke-static {v2}, Landroid/widget/Editor$MagnifierView;->-get12(Landroid/widget/Editor$MagnifierView;)Landroid/view/View;
