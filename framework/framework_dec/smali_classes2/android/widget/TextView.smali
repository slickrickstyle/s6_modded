...
.field static final ID_WEBSEARCH:I = 0x1020541
...
.field private static final SURVEY_APP_NAME:Ljava/lang/String; = "com.sec.fw.copypaste"
...
.method static synthetic -wrap10(Landroid/widget/TextView;Lcom/samsung/android/content/clipboard/data/SemClipData;)V
    .locals 0
...
.method static synthetic -wrap11(Landroid/widget/TextView;Ljava/lang/CharSequence;III)V
    .locals 0
...
.method static synthetic -wrap12(Landroid/widget/TextView;)V
    .locals 0
...
.method static synthetic -wrap7(Landroid/widget/TextView;II)Z
    .locals 1
...
.method static synthetic -wrap8(Landroid/widget/TextView;)Z
    .locals 1
...
.method static synthetic -wrap9(Landroid/widget/TextView;)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/widget/TextView;->ENABLE_SURVEY_MODE:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    sget-object v76, Landroid/widget/TextView$BufferType;->NORMAL:Landroid/widget/TextView$BufferType;
    ...
    sget-object v76, Landroid/widget/TextView;->NO_FILTERS:[Landroid/text/InputFilter;
    ...
    invoke-virtual/range {v76 .. v76}, Landroid/sec/enterprise/EnterpriseDeviceManager;->getRestrictionPolicy()Landroid/sec/enterprise/RestrictionPolicy;
    ...
    new-instance v76, Landroid/text/TextPaint;

    const/16 v77, 0x1

    invoke-direct/range {v76 .. v77}, Landroid/text/TextPaint;-><init>(I)V
    ...
    invoke-virtual/range {v76 .. v77}, Landroid/text/TextPaint;->setCompatibilityScaling(F)V

    new-instance v76, Landroid/graphics/Paint;

    const/16 v77, 0x1

    invoke-direct/range {v76 .. v77}, Landroid/graphics/Paint;-><init>(I)V
    ...
    invoke-virtual/range {v76 .. v77}, Landroid/graphics/Paint;->setCompatibilityScaling(F)V
    ...
    sget-object v76, Lcom/android/internal/R$styleable;->TextViewAppearance:[I
    ...
    sget-object v76, Lcom/android/internal/R$styleable;->TextAppearance:[I
    ...
    invoke-virtual/range {v76 .. v76}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;
    ...
    sget-object v76, Lcom/android/internal/R$styleable;->TextView:[I
    ...
    sget-boolean v76, Landroid/os/Build;->IS_SYSTEM_SECURE:Z
    ...
    invoke-virtual/range {v76 .. v76}, Landroid/widget/Editor;->createInputContentTypeIfNeeded()V
    ...
    const-string/jumbo v76, "TextView"

    const-string/jumbo v77, "Failure reading input extras"
    ...
    new-instance v72, Landroid/util/TypedValue;

    invoke-direct/range {v72 .. v72}, Landroid/util/TypedValue;-><init>()V
    ...
    invoke-virtual/range {v77 .. v77}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v77

    invoke-virtual/range {v77 .. v77}, Landroid/content/res/Resources;->getDisplayMetrics()Landroid/util/DisplayMetrics;

    move-result-object v77

    invoke-static/range {v76 .. v77}, Landroid/util/TypedValue;->complexToDimensionPixelSize(ILandroid/util/DisplayMetrics;)I
    ...
    invoke-virtual/range {v77 .. v77}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;
    ...
    invoke-static/range {v76 .. v76}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;
    :try_end_1
    ...
    check-cast v76, Landroid/text/method/KeyListener;
    ...
    new-instance v76, Landroid/widget/TextView$Drawables;
    ...
    new-instance v76, Landroid/text/method/AllCapsTransformationMethod;

    invoke-virtual/range {p0 .. p0}, Landroid/widget/TextView;->getContext()Landroid/content/Context;

    move-result-object v77

    invoke-direct/range {v76 .. v77}, Landroid/text/method/AllCapsTransformationMethod;-><init>(Landroid/content/Context;)V
    ...
    new-instance v77, Landroid/text/InputFilter$LengthFilter;
    ...
    :cond_16
    sget-object v76, Lcom/android/internal/R$styleable;->View:[I
    ...
    new-instance v76, Ljava/lang/RuntimeException;
    ...
    invoke-interface/range {v76 .. v76}, Landroid/text/method/KeyListener;->getInputType()I
    :try_end_4
    ...
    invoke-static/range {v77 .. v77}, Landroid/text/method/DigitsKeyListener;->getInstance(Ljava/lang/String;)Landroid/text/method/DigitsKeyListener;
    ...
    :pswitch_69
    sget-object v76, Landroid/text/TextUtils$TruncateAt;->START:Landroid/text/TextUtils$TruncateAt;
    ...
    :pswitch_6a
    sget-object v76, Landroid/text/TextUtils$TruncateAt;->MIDDLE:Landroid/text/TextUtils$TruncateAt;
    ...
    :pswitch_6b
    sget-object v76, Landroid/text/TextUtils$TruncateAt;->END:Landroid/text/TextUtils$TruncateAt;
    ...
    invoke-virtual/range {v76 .. v76}, Landroid/view/ViewConfiguration;->isFadingMarqueeEnabled()Z
    ...
    :goto_17
    sget-object v76, Landroid/text/TextUtils$TruncateAt;->MARQUEE:Landroid/text/TextUtils$TruncateAt;
    ...
    :cond_2e
    const/high16 v76, -0x1000000

    invoke-static/range {v76 .. v76}, Landroid/content/res/ColorStateList;->valueOf(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual/range {v76 .. v76}, Landroid/widget/Editor;->prepareCursorControllers()V
    ...
    :cond_39
    new-instance v76, Landroid/widget/TextView$TextViewClipboardEventListener;
    ...
    new-instance v76, Lcom/samsung/android/cover/CoverManager;
...
.method public insertLog(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-boolean v2, Landroid/widget/TextView;->ENABLE_SURVEY_MODE:Z
...
.method protected onAttachedToWindow()V
    ...
    iput-boolean v1, p0, Landroid/widget/TextView;->mAttachedWindow:Z
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    sget-boolean v36, Landroid/widget/TextView;->sIsSpenUspLevel3:Z
    ...
    :try_start_0
    new-instance v14, Lcom/samsung/android/infoextraction/SemInfoExtractionManager;
    ...
    invoke-direct {v14, v0}, Lcom/samsung/android/infoextraction/SemInfoExtractionManager;-><init>(Landroid/content/Context;)V

    invoke-virtual {v14}, Lcom/samsung/android/infoextraction/SemInfoExtractionManager;->hideLinkPreview()V
    :try_end_0
    ...
    invoke-direct {v0, v1, v2}, Landroid/widget/TextView$5;-><init>(Landroid/widget/TextView;Landroid/view/InputDevice;)V
    ...
    invoke-interface {v0, v1, v10}, Ljava/lang/CharSequence;->subSequence(II)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v14, v0, v1}, Lcom/samsung/android/infoextraction/SemInfoExtractionManager;->showLinkPreview(Ljava/lang/String;Landroid/graphics/Rect;)V
    ...
    invoke-direct {v0, v1, v2}, Landroid/widget/TextView$6;-><init>(Landroid/widget/TextView;Landroid/view/InputDevice;)V
...
.method public onMultiSelectMenuItem(Landroid/view/MenuItem;)Z
    .locals 14
    ...
    const-string/jumbo v12, "getTextFormultiSelection() text is null"
    ...
    const-string/jumbo v12, "Multi Selected Text String is null"
    ...
    invoke-virtual {p0, v6}, Landroid/widget/TextView;->getVisibleTextRange([I)Z
    ...
    invoke-static {v10, v11, v12}, Landroid/text/MultiSelection;->setSelection(Landroid/text/Spannable;II)V
    ...
    invoke-virtual {v11, v12}, Landroid/sec/enterprise/RestrictionPolicy;->isClipboardAllowed(Z)Z
    ...
    invoke-virtual {v0, v8}, Lcom/samsung/android/content/clipboard/data/SemTextClipData;->setText(Ljava/lang/CharSequence;)Z
    ...
    invoke-static {v11, v9}, Landroid/content/ClipData;->newPlainText(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/content/ClipData;
    ...
    invoke-virtual {p0, v8, v12, v11}, Landroid/widget/TextView;->sendToDictionary(Ljava/lang/String;II)V
    ...
    const-string/jumbo v11, "android.intent.action.PROCESS_TEXT"
    ...
    const-string/jumbo v11, "android.intent.extra.PROCESS_TEXT"

    invoke-virtual {v5, v11, v8}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const/16 v11, 0x64

    invoke-virtual {p0, v5, v11}, Landroid/widget/TextView;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    const-string/jumbo v12, "Share failed"

    invoke-static {v11, v12}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v11, "TextView"

    const-string/jumbo v12, "ActivityNotFoundException"
...
.method public setTextIsSelectable(Z)V
    ...
    :cond_4
    sget-boolean v1, Landroid/widget/TextView;->sIsSpenUspLevel3:Z
