...
.field public static final ACCESSIBILITY_DISPLAY_COLOR_MATRIX:Ljava/lang/String; = "accessibility_display_color_matrix"
...
.field public static final ACCESSIBILITY_NON_WEB_GRANULARITY:Ljava/lang/String; = "accessibility_non_web_granularity"
...
.field public static final ACCESSIBILITY_SINGLE_TAP_SELECTION:Ljava/lang/String; = "accessibility_single_tap_selection"
...
.field public static final ACCESSIBILITY_UNIVERSAL_SWITCH_BLUETOOTH_KEY_MAPPED:Ljava/lang/String; = "universal_switch_bluetooth_key_mapped"

.field public static final ACCESSIBILITY_UNIVERSAL_SWITCH_CURSOR_COLOR:Ljava/lang/String; = "accessibility_universal_switch_cursor_color"

.field public static final ACCESSIBILITY_UNIVERSAL_SWITCH_ENABLED:Ljava/lang/String; = "universal_switch_enabled"

.field public static final ACCESSIBILITY_UNIVERSAL_SWITCH_ENABLED_FROM_DIRECTACCESS:Ljava/lang/String; = "universal_switch_enabled_from_directaccess"

.field public static final ACCESSIBILITY_UNIVERSAL_SWITCH_SCREEN_AS_SWITCH:Ljava/lang/String; = "accessibility_universal_switch_screen_as_switch"
...
.field public static final ACCESSIBILITY_WEB_GRANULARITY:Ljava/lang/String; = "accessibility_web_granularity"
...
.field public static final BRIGHTNESS_USE_TWILIGHT:Ljava/lang/String; = "brightness_use_twilight"
...
.field public static final CARRIER_MATCH_ALWAYS_ASK:Ljava/lang/String; = "carrier_match_always_ask"

.field public static final CARRIER_MATCH_AUTO_SYNC:Ljava/lang/String; = "carrier_match_auto_sync"

.field public static final CARRIER_MATCH_DEFAULT_AREA_CODE:Ljava/lang/String; = "carrier_match_default_area_code"

.field public static final CARRIER_MATCH_ENABLED:Ljava/lang/String; = "carrier_match_enabled"

.field public static final CARRIER_MATCH_SMARTCSP:Ljava/lang/String; = "carrier_match_smartcsp"
...
.field public static final CDMA_ROAM_GUARD_DATA_LTE_FORCED:Ljava/lang/String; = "roam_guard_data_lte_forced"

.field public static final CDMA_ROAM_GUARD_DATA_LTE_INTERNATIONAL:Ljava/lang/String; = "roam_guard_data_lte_international"

.field public static final CDMA_ROAM_GUARD_DATA_LTE_INTERNATIONAL_FORCED:Ljava/lang/String; = "roam_guard_data_lte_international_forced"
...
.field public static final CDMA_ROAM_SETTING_DATA_LTE_FORCED:Ljava/lang/String; = "roam_setting_data_lte_forced"

.field public static final CDMA_ROAM_SETTING_DATA_LTE_INTERNATIONAL:Ljava/lang/String; = "roam_setting_data_lte_international"

.field public static final CDMA_ROAM_SETTING_DATA_LTE_INTERNATIONAL_FORCED:Ljava/lang/String; = "roam_setting_data_lte_international_forced"
...
.field public static final ENABLED_ACCESSIBILITY_SAMSUNG_SCREEN_READER:Ljava/lang/String; = "enabled_accessibility_samsung_screen_reader"

.field public static final ENABLED_ACCESSIBILITY_SERVICES:Ljava/lang/String; = "enabled_accessibility_services"

.field public static final ENABLED_ACCESSIBILITY_S_TALKBACK:Ljava/lang/String; = "enabled_accessibility_s_talkback"
...
.field public static final INTERACTION_CONTROL_EXIT_LOCKED:Ljava/lang/String; = "interaction_control_exit_locked"
...
.field public static final LOCATION_MODE_PREVIOUS:I = -0x1
...
.field public static final LOCATION_PREVIOUS_MODE:Ljava/lang/String; = "location_previous_mode"
...
.field public static final NETWORK_OPERATOR_AUTO_MANUAL:Ljava/lang/String; = "network_operator_choice_auto_manual"
...
.field public static final TWILIGHT_MODE:Ljava/lang/String; = "twilight_mode"

.field public static final TWILIGHT_MODE_AUTO:I = 0x2

.field public static final TWILIGHT_MODE_AUTO_OVERRIDE_OFF:I = 0x3

.field public static final TWILIGHT_MODE_AUTO_OVERRIDE_ON:I = 0x4

.field public static final TWILIGHT_MODE_LOCKED_OFF:I = 0x0

.field public static final TWILIGHT_MODE_LOCKED_ON:I = 0x1
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v3, "PUT_secure"
    ...
    const-string/jumbo v1, "assisted_gps_configurable_list"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "assisted_gps_supl_host"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "assisted_gps_supl_port"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "assisted_gps_position_mode"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "assisted_gps_network"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "assisted_gps_reset_type"
    ...
    const-string/jumbo v1, "wifi_watchdog_poor_network_avoidance_enabled"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "wifi_watchdog_poor_network_dialog_do_not_show"
    ...
    const-string/jumbo v1, "wifi_share_profile"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "wifi_ap_powersave_alarm_settings"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "global_http_proxy_username"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "global_http_proxy_password"
    ...
    const-string/jumbo v1, "data_encryption"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "boot_lock"

    invoke-virtual {v0, v1}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    sget-object v0, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    const-string/jumbo v1, "adb_blocked"
    ...
    const-string/jumbo v1, "emergency_lock"
    ...
    const-string/jumbo v1, "apn_locked"
    ...
    const-string/jumbo v1, "location_previous_mode"
...
.method public static moveProtectDB(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
    ...
    const-string/jumbo v2, " to android.provider.Settings.Secure, writing PROTECT DB"
...
.method private static final restoreLocationModeForUser(Landroid/content/ContentResolver;I)Z
    .locals 3
    ...
    invoke-static {p0, v1, v2, p1}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    :cond_0
    invoke-static {p0, v0, p1}, Landroid/provider/Settings$Secure;->setLocationModeForUser(Landroid/content/ContentResolver;II)Z
...
.method private static final saveLocationModeForUser(Landroid/content/ContentResolver;I)Z
    .locals 2

    invoke-static {p0, p1}, Landroid/provider/Settings$Secure;->getLocationModeForUser(Landroid/content/ContentResolver;I)I
...
.method private static final setLocationModeForUser(Landroid/content/ContentResolver;II)Z
    ...
    :pswitch_0
    :try_start_1
    invoke-static {p0, p2}, Landroid/provider/Settings$Secure;->restoreLocationModeForUser(Landroid/content/ContentResolver;I)Z
    :try_end_1
    ...
    :pswitch_1
    :try_start_2
    invoke-static {p0, p2}, Landroid/provider/Settings$Secure;->saveLocationModeForUser(Landroid/content/ContentResolver;I)Z
