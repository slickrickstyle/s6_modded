...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->-wrap21(Lcom/android/server/display/DisplayManagerService;)V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/display/DisplayManagerService;->-wrap6(Lcom/android/server/display/DisplayManagerService;Landroid/os/Bundle;I)V
    ...
    invoke-static {v1, v0}, Lcom/android/server/display/DisplayManagerService;->-set2(Lcom/android/server/display/DisplayManagerService;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/display/DisplayManagerService;->-wrap8(Lcom/android/server/display/DisplayManagerService;Landroid/os/Bundle;I)V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/display/DisplayManagerService;->-wrap9(Lcom/android/server/display/DisplayManagerService;Landroid/os/Bundle;I)V
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->-get16(Lcom/android/server/display/DisplayManagerService;)Landroid/view/WindowManagerInternal;
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->-get13(Lcom/android/server/display/DisplayManagerService;)Landroid/hardware/display/DisplayViewport;
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->-get14(Lcom/android/server/display/DisplayManagerService;)Landroid/hardware/display/DisplayViewport;
    ...
    invoke-static {v1}, Lcom/android/server/display/DisplayManagerService;->-get13(Lcom/android/server/display/DisplayManagerService;)Landroid/hardware/display/DisplayViewport;
