...
.method private readUserLP(I)Lcom/android/server/pm/UserManagerService$UserData;
    ...
    :try_start_0
    new-instance v39, Landroid/util/XmlMoreAtomicFile;
    ...
    invoke-direct/range {v43 .. v45}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-virtual/range {v39 .. v39}, Landroid/util/XmlMoreAtomicFile;->openRead()Ljava/io/FileInputStream;
    ...
    sget-object v43, Ljava/nio/charset/StandardCharsets;->UTF_8:Ljava/nio/charset/Charset;
    ...
    const-string/jumbo v44, "Unable to read user "
    ...
    const-string/jumbo v44, "Unable id "
    ...
    const-string/jumbo v44, " does not match the file name "
    ...
    :cond_5
    :try_start_5
    const-string/jumbo v43, "serialNumber"
    ...
    const-string/jumbo v43, "created"
    ...
    const-string/jumbo v43, "lastLoggedIn"
    ...
    const-string/jumbo v43, "lastLoggedInFingerprint"
    ...
    const-string/jumbo v43, "profileGroupId"
    ...
    const-string/jumbo v43, "restrictedProfileParentId"
    ...
    const-string/jumbo v43, "partial"
    ...
    :cond_6
    const-string/jumbo v43, "guestToRemove"
    ...
    :cond_7
    const-string/jumbo v43, "hasCCMBeenProvisioned"
    ...
    :cond_8
    const-string/jumbo v43, "seedAccountName"
    ...
    const-string/jumbo v43, "seedAccountType"
    ...
    :cond_d
    const-string/jumbo v43, "restrictions"
    ...
    const-string/jumbo v44, "IOException during readUserLocked for id "
    ...
    :cond_f
    :try_start_8
    const-string/jumbo v43, "device_policy_restrictions"
    ...
    const-string/jumbo v44, "XmlPullParserException during readUserLocked for id "
    ...
    invoke-virtual/range {v25 .. v25}, Lorg/xmlpull/v1/XmlPullParserException;->printStackTrace()V
    :try_end_9
    .catchall {:try_start_9 .. :try_end_9} :catchall_1
    ...
    :cond_10
    :try_start_b
    const-string/jumbo v43, "account"
    ...
    :cond_11
    const-string/jumbo v43, "seedAccountOptions"
    ...
    :cond_12
    new-instance v41, Landroid/content/pm/UserInfo;
    ...
    invoke-virtual/range {v41 .. v41}, Landroid/content/pm/UserInfo;->isKnoxWorkspace()Z
    ...
    :cond_13
    new-instance v38, Lcom/android/server/pm/UserManagerService$UserData;
    ...
    const-string/jumbo v44, "failed to read user "
    ...
    const-string/jumbo v44, ", giving up"
...
.method private readUserListLP()V
    ...
    iget-object v14, v0, Lcom/android/server/pm/UserManagerService;->mUserListFile:Ljava/io/File;
    ...
    const-string/jumbo v14, "LL"

    move-object/from16 v0, p0

    invoke-direct {v0, v14}, Lcom/android/server/pm/UserManagerService;->writeFotaLocked(Ljava/lang/String;)V
    ...
    iget-object v14, v0, Lcom/android/server/pm/UserManagerService;->mIsFotaFile:Ljava/io/File;
    ...
    new-instance v12, Landroid/util/XmlMoreAtomicFile;

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/pm/UserManagerService;->mUserListFile:Ljava/io/File;

    invoke-direct {v12, v14}, Landroid/util/XmlMoreAtomicFile;-><init>(Ljava/io/File;)V

    :try_start_0
    invoke-virtual {v12}, Landroid/util/XmlMoreAtomicFile;->openRead()Ljava/io/FileInputStream;
    ...
    invoke-interface {v8, v1, v14}, Lorg/xmlpull/v1/XmlPullParser;->setInput(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    invoke-virtual {v12}, Landroid/util/XmlMoreAtomicFile;->processDamagedFile()V

    const-string/jumbo v14, "Unable to read user list"
    ...
    const-string/jumbo v14, "nextSerialNumber"
    ...
    iput v14, v0, Lcom/android/server/pm/UserManagerService;->mUserVersion:I
    ...
    invoke-direct {v0, v14}, Lcom/android/server/pm/UserManagerService;->readUserLP(I)Lcom/android/server/pm/UserManagerService$UserData;
    ...
    invoke-virtual {v14, v0, v11}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    iget-object v14, v11, Lcom/android/server/pm/UserManagerService$UserData;->info:Landroid/content/pm/UserInfo;
    ...
    const-string/jumbo v14, "IOException during readUserListLocked"
    ...
    const-string/jumbo v14, "XmlPullParserException during readUserListLocked"
    ...
    const-string/jumbo v15, " might be broken"
    ...
    :cond_b
    :try_start_8
    const-string/jumbo v14, "guestRestrictions"
    ...
    iget-object v14, v0, Lcom/android/server/pm/UserManagerService;->mGuestRestrictions:Landroid/os/Bundle;

    invoke-static {v8, v14}, Lcom/android/server/pm/UserRestrictionsUtils;->readRestrictions(Lorg/xmlpull/v1/XmlPullParser;Landroid/os/Bundle;)V
    :try_end_9
    ...
    invoke-static {v8, v6}, Lcom/android/server/pm/UserRestrictionsUtils;->readRestrictions(Lorg/xmlpull/v1/XmlPullParser;Landroid/os/Bundle;)V

    goto/16 :goto_0

    :cond_e
    const-string/jumbo v14, "globalRestrictionOwnerUserId"
    ...
    iput v14, v0, Lcom/android/server/pm/UserManagerService;->mGlobalRestrictionOwnerUserId:I
    ...
    const-string/jumbo v14, "there isn\'t owner user, fallback to single user"
    ...
    iget-object v14, v0, Lcom/android/server/pm/UserManagerService;->mRestrictionsLock:Ljava/lang/Object;
    ...
    iput-object v6, v0, Lcom/android/server/pm/UserManagerService;->mDevicePolicyGlobalUserRestrictions:Landroid/os/Bundle;
    :try_end_c
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/pm/UserManagerService;->upgradeIfNecessaryLP()V
...
.method private writeUserLP(Lcom/android/server/pm/UserManagerService$UserData;)V
    ...
    new-instance v4, Landroid/util/XmlMoreAtomicFile;
    ...
    invoke-direct {v4, v6}, Landroid/util/XmlMoreAtomicFile;-><init>(Ljava/io/File;)V
    ...
    invoke-virtual {v4, v1}, Landroid/util/XmlMoreAtomicFile;->finishWrite(Ljava/io/FileOutputStream;)V
    ...
    invoke-virtual {v4, v1}, Landroid/util/XmlMoreAtomicFile;->failWrite(Ljava/io/FileOutputStream;)V
