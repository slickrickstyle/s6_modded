...
.method public setSEContainerClipboardMode(II)I
    ...
    const-string/jumbo v10, "setSEContainerClipboardMode"
    ...
    iget-object v14, v0, Lcom/android/server/SEAMService;->PERMS:Ljava/util/ArrayList;

    const/4 v15, 0x1

    move-object/from16 v0, p0

    invoke-direct {v0, v13, v11, v14, v15}, Lcom/android/server/SEAMService;->checkSEAMSPermission(IILjava/util/List;Z)Z
    ...
    const-string/jumbo v16, "setSEContainerClipboardMode: License validation failed"
    ...
    :try_start_0
    invoke-virtual {v8}, Lcom/android/server/SEAMSContainer;->getMDMID()Lcom/android/server/pm/SELinuxMMAC$MDMID;

    move-result-object v9

    iget-object v14, v9, Lcom/android/server/pm/SELinuxMMAC$MDMID;->packageName:Ljava/lang/String;

    iget-object v15, v9, Lcom/android/server/pm/SELinuxMMAC$MDMID;->certs:Ljava/lang/String;

    move/from16 v0, p1

    invoke-static {v14, v15, v0}, Lcom/android/server/pm/SELinuxMMAC;->isContainerCreatedbyCaller(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v17, " is not owned by caller:"

    invoke-virtual/range {v16 .. v17}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v16

    iget-object v0, v9, Lcom/android/server/pm/SELinuxMMAC$MDMID;->packageName:Ljava/lang/String;
    ...
    const-string/jumbo v16, "unable to get instance"
    ...
    const-string/jumbo v17, "setSEContainerClipboardMode() failed with exception: "
    ...
    const-string/jumbo v15, "SeamsClipboardTable"

    const-string/jumbo v16, "mode"

    move-object/from16 v0, v16

    invoke-virtual {v14, v15, v0, v4}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getValue(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)Landroid/content/ContentValues;
    ...
    const-string/jumbo v17, "CHecking if entry already exists:"
    ...
    invoke-virtual {v14, v15, v2, v4}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->putValues(Ljava/lang/String;Landroid/content/ContentValues;Landroid/content/ContentValues;)Z
    ...
    const-string/jumbo v17, "setSecontainerClipboardMode: ret = "
    ...
    const-string/jumbo v16, "CvOld null or size 0"
    ...
    invoke-virtual {v14, v15, v2}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->putValuesNoUpdate(Ljava/lang/String;Landroid/content/ContentValues;)Z
