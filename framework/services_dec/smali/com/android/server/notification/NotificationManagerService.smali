...
.method static synthetic -get24(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/SmartAlertController;
    .locals 1
...
.method static synthetic -get27(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/ZenModeHelper;
    .locals 1
...
.method static synthetic -get9(Lcom/android/server/notification/NotificationManagerService;)Lcom/samsung/android/edge/EdgeManagerInternal;
    .locals 1
...
.method buzzBeepBlinkLocked(Lcom/android/server/notification/NotificationRecord;)V
    ...
    :goto_1
    sget-boolean v35, Lcom/android/server/notification/NotificationManagerService;->DBG:Z
    ...
    :cond_1
    const-string/jumbo v35, "NotificationService"
    ...
    const-string/jumbo v37, " canInterrupt="
    ...
    const-string/jumbo v37, " intercept="
    ...
    const-string/jumbo v36, "Interrupting!"
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/net/Uri;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/media/AudioManager;->getRingerModeInternal()I
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/service/notification/StatusBarNotification;->getPackageName()Ljava/lang/String;
    ...
    invoke-static {v8}, Landroid/media/AudioAttributes;->toLegacyStreamType(Landroid/media/AudioAttributes;)I

    move-result v36

    invoke-virtual/range {v35 .. v36}, Landroid/media/AudioManager;->getStreamVolume(I)I
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/media/AudioManager;->isAudioFocusExclusive()Z
    ...
    sget-object v39, Landroid/os/Vibrator$SemMagnitudeTypes;->TYPE_NOTIFICATION:Landroid/os/Vibrator$SemMagnitudeTypes;
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/os/Vibrator;->semVibrate([JILandroid/media/AudioAttributes;Landroid/os/Vibrator$SemMagnitudeTypes;)V
    :try_end_1
    ...
    invoke-static/range {v35 .. v35}, Landroid/view/accessibility/AccessibilityManager;->getInstance(Landroid/content/Context;)Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-virtual {v7, v0}, Landroid/view/accessibility/AccessibilityManager;->semOnLightNotification(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/android/server/lights/Light;->pulse()V
    ...
    const-string/jumbo v36, "Suppressed SystemUI from triggering screen on"
    ...
    invoke-virtual/range {v35 .. v36}, Lcom/android/server/notification/ManagedServices$UserProfiles;->isCurrentProfile(I)Z
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/media/AudioManager;->getRingtonePlayer()Landroid/media/IRingtonePlayer;
    ...
    const-string/jumbo v37, "Playing sound "
    ...
    const-string/jumbo v37, " with attributes "
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/service/notification/StatusBarNotification;->getUser()Landroid/os/UserHandle;
    ...
    invoke-interface {v0, v1, v2, v3, v8}, Landroid/media/IRingtonePlayer;->playAsync(Landroid/net/Uri;Landroid/os/UserHandle;ZLandroid/media/AudioAttributes;)V

    const/4 v9, 0x1

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/notification/NotificationManagerService;->mEasyMuteController:Lcom/android/server/notification/EasyMuteController;
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/android/server/notification/EasyMuteController;->registerListener()V
    :try_end_2
    ...
    iget-object v0, v0, Lcom/android/server/notification/NotificationManagerService;->mHandler:Landroid/os/Handler;
...
.method enqueueNotificationInternal(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;ILandroid/app/Notification;[II)V
    ...
    const-string/jumbo v7, ") above 1000000"
