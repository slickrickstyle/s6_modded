...
.method private onLoadSoundEffects()Z
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get66(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get74(Lcom/android/server/audio/AudioService;)Z
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get68(Lcom/android/server/audio/AudioService;)Landroid/media/SoundPool;
    :try_end_1
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-wrap30(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->-set36(Lcom/android/server/audio/AudioService;Landroid/media/SoundPool;)Landroid/media/SoundPool;

    iget-object v10, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    const/4 v12, 0x0

    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->-set37(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$SoundPoolCallback;)Lcom/android/server/audio/AudioService$SoundPoolCallback;
    ...
    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->-set38(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$SoundPoolListenerThread;)Lcom/android/server/audio/AudioService$SoundPoolListenerThread;

    iget-object v10, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get70(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$SoundPoolListenerThread;
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get69(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$SoundPoolCallback;
    :try_end_2
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get71(Lcom/android/server/audio/AudioService;)Landroid/os/Looper;
    ...
    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->-set39(Lcom/android/server/audio/AudioService;Landroid/os/Looper;)Landroid/os/Looper;
...
.method private onPersistSafeVolumeState(I)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get28(Lcom/android/server/audio/AudioService;)Landroid/content/ContentResolver;
...
.method private onPlaySoundEffect(II)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get66(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get68(Lcom/android/server/audio/AudioService;)Landroid/media/SoundPool;
...
.method private onUnloadSoundEffects()V
    ...
    invoke-static {v3}, Lcom/android/server/audio/AudioService;->-get66(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v3}, Lcom/android/server/audio/AudioService;->-get68(Lcom/android/server/audio/AudioService;)Landroid/media/SoundPool;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v3, v5}, Lcom/android/server/audio/AudioService;->-set36(Lcom/android/server/audio/AudioService;Landroid/media/SoundPool;)Landroid/media/SoundPool;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private persistRingerMode(I)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get78(Lcom/android/server/audio/AudioService;)Z
...
.method private persistVolume(Lcom/android/server/audio/AudioService$VolumeStreamState;I)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get73(Lcom/android/server/audio/AudioService;)[I
    ...
    invoke-static {v0, p2}, Lcom/android/server/audio/AudioService;->-wrap16(Lcom/android/server/audio/AudioService;I)Ljava/lang/String;

    move-result-object v7

    iget-object v0, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get19(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v7, v8}, Lcom/android/server/audio/AudioService;->updateBluetoothVolume(Ljava/lang/String;Z)V
...
.method private setAllVolumes(Lcom/android/server/audio/AudioService$VolumeStreamState;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get73(Lcom/android/server/audio/AudioService;)[I
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get72(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
...
.method private setDeviceVolume(Lcom/android/server/audio/AudioService$VolumeStreamState;I)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get72(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
...
.method private setForceUse(II)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get27(Lcom/android/server/audio/AudioService;)Landroid/util/ArrayMap;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v4, v2}, Lcom/android/server/audio/AudioService;->-wrap31(Lcom/android/server/audio/AudioService;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/server/audio/AudioService;->-wrap42(Lcom/android/server/audio/AudioService;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v3}, Lcom/android/server/audio/AudioService;->-set24(Lcom/android/server/audio/AudioService;I)I
    ...
    invoke-static {v3, v2, v4}, Lcom/android/server/audio/AudioService;->-wrap41(Lcom/android/server/audio/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    invoke-static {v2, v4, v5}, Lcom/android/server/audio/AudioService;->-set23(Lcom/android/server/audio/AudioService;J)J
    ...
    invoke-static {v4, v3, v2}, Lcom/android/server/audio/AudioService;->-wrap36(Lcom/android/server/audio/AudioService;ZLjava/lang/String;)V
    ...
    invoke-static {v2, v3}, Lcom/android/server/audio/AudioService;->-wrap33(Lcom/android/server/audio/AudioService;I)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get28(Lcom/android/server/audio/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v2, v3, v4}, Lcom/android/server/audio/AudioService;->-wrap43(Lcom/android/server/audio/AudioService;II)V
    ...
    invoke-static {v3, v2, v4}, Lcom/android/server/audio/AudioService;->-wrap37(Lcom/android/server/audio/AudioService;Ljava/lang/String;I)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-wrap23(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-wrap45(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-wrap75(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v2, v3, v4}, Lcom/android/server/audio/AudioService;->-wrap39(Lcom/android/server/audio/AudioService;II)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get82(Lcom/android/server/audio/AudioService;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-wrap18(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get67(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$SoundKitchen;
    ...
    invoke-static {v2, v0}, Lcom/android/server/audio/AudioService;->-wrap53(Lcom/android/server/audio/AudioService;I)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get45(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/MediaFocusControl;
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get49(Lcom/android/server/audio/AudioService;)I
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-wrap35(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-wrap52(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v4}, Lcom/android/server/audio/AudioService;->-get72(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
    ...
    invoke-static {v5, v6}, Lcom/android/server/audio/AudioService;->-wrap11(Lcom/android/server/audio/AudioService;I)I
    ...
    invoke-static {v5, v6}, Lcom/android/server/audio/AudioService;->-wrap13(Lcom/android/server/audio/AudioService;I)I

    move-result v5

    const/4 v6, 0x3

    invoke-static {v2, v6, v3, v4, v5}, Lcom/android/server/audio/AudioService;->-wrap58(Lcom/android/server/audio/AudioService;IIII)V
