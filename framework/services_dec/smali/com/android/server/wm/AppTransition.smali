...
.field private static final NEXT_TRANSIT_TYPE_CUSTOM_SCALE_DOWN:I = 0x3ea
...
.method loadAnimation(Landroid/view/WindowManager$LayoutParams;IZIILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZIZLandroid/graphics/Rect;Lcom/android/server/wm/AppWindowToken;)Landroid/view/animation/Animation;
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/server/wm/Task;->inFreeformWorkspace()Z
    ...
    iget-object v13, v5, Lcom/android/server/wm/WindowManagerService;->mMultiWindowManagerInternal:Lcom/android/server/wm/IMultiWindowManagerInternalBridge;

    move-object/from16 v0, v24

    iget v14, v0, Lcom/android/server/wm/Task;->mFreeformTransit:I
    ...
    invoke-interface/range {v13 .. v20}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->loadMultiWindowTransitionLocked(IILandroid/graphics/Rect;Landroid/graphics/Rect;ZZLandroid/view/animation/Animation;)Landroid/view/animation/Animation;
    ...
    const-string/jumbo v22, "ANIM_THUMBNAIL_SCALE_UP"
    ...
    :cond_1b
    const-string/jumbo v22, "ANIM_THUMBNAIL_SCALE_DOWN"
    ...
    const-string/jumbo v22, "ANIM_THUMBNAIL_ASPECT_SCALE_UP"
    ...
    :cond_20
    const-string/jumbo v22, "ANIM_THUMBNAIL_ASPECT_SCALE_DOWN"
    ...
    invoke-interface {v5, v0, v1, v2}, Lcom/android/server/wm/IWindowManagerServiceBridge;->createSamsungCustomScaleDownAnimationLocked(IZLandroid/graphics/Rect;)Landroid/view/animation/Animation;
    ...
    invoke-interface/range {v5 .. v12}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->loadMultiWindowTransitionLocked(IILandroid/graphics/Rect;Landroid/graphics/Rect;ZZLandroid/view/animation/Animation;)Landroid/view/animation/Animation;
