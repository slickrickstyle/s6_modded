...
.method computeShownFrameLocked()V
    ...
    invoke-interface/range {v45 .. v46}, Lcom/android/server/wm/HorizontalModeService;->getTransformation(Lcom/android/server/wm/AppWindowToken;)Landroid/view/animation/Transformation;
    ...
    sget-boolean v45, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SAMSUNG_MULTIWINDOW_DYNAMIC_ENABLED:Z

    if-eqz v45, :cond_2

    sget-boolean v45, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_GHOST_MODE:Z
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->inFreeformWorkspace()Z
    ...
    invoke-interface/range {v45 .. v46}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isFreeformAlphaModeLocked(Lcom/android/server/wm/WindowState;)Z

    move-result v16

    :cond_1
    :goto_3
    sget-boolean v45, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_SLIDE_MODE:Z
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->getTask()Lcom/android/server/wm/Task;
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WallpaperController;->getWallpaperTarget()Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v46 .. v46}, Lcom/android/server/wm/WindowState;->getDisplayId()I

    move-result v46

    invoke-interface/range {v45 .. v46}, Lcom/android/server/am/IMultiScreenManagerServiceBridge;->isTransiting(I)Z
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/wm/ScreenRotationAnimation;->isAnimating()Z
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/wm/ScreenRotationAnimation;->isRotating()Z
    ...
    div-float v47, v38, v47

    const/high16 v48, 0x40000000    # 2.0f

    div-float v48, v17, v48
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->isAnimatingLw()Z
    ...
    invoke-virtual/range {v45 .. v45}, Landroid/view/animation/Transformation;->getMatrix()Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->isChildWindow()Z
    ...
    sub-float v32, v8, v25

    sub-float v33, v9, v26
    ...
    :cond_a
    sget-boolean v45, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SNAP_VIEW_SUPPORT:Z
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->isSnapViewTarget()Z
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/wm/ScreenRotationAnimation;->getEnterTransformation()Landroid/view/animation/Transformation;
    ...
    invoke-virtual/range {v45 .. v46}, Lcom/android/server/wm/AccessibilityController;->getMagnificationSpecForWindowLocked(Lcom/android/server/wm/WindowState;)Landroid/view/MagnificationSpec;
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->getWindowEasyOneHandScaleSpecLocked()Landroid/view/MagnificationSpec;
    ...
    invoke-virtual/range {v31 .. v31}, Landroid/view/MagnificationSpec;->isNop()Z
    ...
    invoke-virtual/range {v45 .. v47}, Landroid/graphics/Point;->set(II)V
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/AppWindowAnimator;->isAnimating()Z
    ...
    invoke-static/range {v45 .. v45}, Landroid/graphics/PixelFormat;->formatHasAlpha(I)Z
    ...
    invoke-virtual/range {v45 .. v49}, Lcom/android/server/wm/WindowState;->isIdentityMatrix(FFFF)Z
    ...
    invoke-virtual/range {v46 .. v46}, Landroid/view/animation/Transformation;->getAlpha()F
    ...
    invoke-virtual/range {v45 .. v46}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->layoutInParentFrame()Z
    ...
    invoke-virtual/range {v45 .. v47}, Landroid/graphics/Rect;->offset(II)V
    ...
    invoke-virtual/range {v45 .. v46}, Landroid/graphics/Rect;->scale(F)V
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->getBridge()Lcom/samsung/android/view/IWindowStateBridge;

    move-result-object v45

    invoke-interface/range {v45 .. v45}, Lcom/samsung/android/view/IWindowStateBridge;->isFixedOrientation()Z
    ...
    invoke-virtual/range {v45 .. v46}, Lcom/android/server/wm/WindowSurfaceController;->setAlpha(F)V

    sget-boolean v45, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_ANIM:Z
    ...
    const-string/jumbo v47, "dimTransformation: alpha ="
    ...
    invoke-static/range {v45 .. v46}, Landroid/util/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I

    :cond_1b
    sget-boolean v45, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_SURFACE_TRACE:Z

    if-nez v45, :cond_1c

    sget-boolean v45, Lcom/android/server/wm/WindowManagerService;->localLOGV:Z
    ...
    :cond_1d
    sget-object v46, Lcom/android/server/wm/WindowStateAnimator;->TAG:Ljava/lang/String;

    new-instance v45, Ljava/lang/StringBuilder;

    invoke-direct/range {v45 .. v45}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v47, "computeShownFrameLocked: Animating "
    ...
    const-string/jumbo v47, " attached="
    ...
    invoke-virtual/range {v45 .. v45}, Landroid/view/animation/Animation;->getDetachWallpaper()Z
    ...
    sget-boolean v45, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_WALLPAPER:Z
    ...
    const-string/jumbo v47, "WP target app xform: "
    ...
    const-string/jumbo v47, "WP target attached xform: "
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/AppWindowToken;->findMainWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-interface/range {v45 .. v45}, Lcom/samsung/android/view/IWindowStateBridge;->hasFixedOrientation()Z
    ...
    sub-float v45, v46, v45

    mul-float v45, v45, v10
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->isDragResizeChanged()Z
    ...
    invoke-virtual/range {v34 .. v34}, Lcom/android/server/wm/Task;->inFreeformWorkspace()Z

    move-result v45

    if-eqz v45, :cond_3e

    invoke-virtual/range {v34 .. v34}, Lcom/android/server/wm/Task;->isDragResizing()Z
    ...
    invoke-virtual/range {v45 .. v45}, Lcom/android/server/wm/WindowState;->isDragResizing()Z
    ...
    const-string/jumbo v47, "computeShownFrameLocked: "
    ...
    const-string/jumbo v47, " not attached, mAlpha="
    ...
    invoke-interface/range {v45 .. v46}, Lcom/android/server/am/IMultiScreenManagerServiceBridge;->isVirtualScreen(I)Z
    ...
    invoke-virtual/range {v45 .. v47}, Landroid/graphics/Point;->offset(II)V
