...
.field mSamsungPolicy:Lcom/android/server/policy/SamsungWindowManagerPolicy;
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    iput-object v0, v1, Lcom/android/server/wm/WindowState;->mSamsungPolicy:Lcom/android/server/policy/SamsungWindowManagerPolicy;
    ...
    check-cast v18, Lcom/android/server/policy/PhoneWindowManager;

    invoke-virtual/range {v18 .. v18}, Lcom/android/server/policy/PhoneWindowManager;->getSamsungPolicy()Lcom/android/server/policy/SamsungWindowManagerPolicy;
...
.method private setReplacingWindowForChild(Lcom/android/server/wm/WindowState;)V
    .locals 6
    ...
    iget-object v4, p1, Lcom/android/server/wm/WindowState;->mReplacingWindow:Lcom/android/server/wm/WindowState;
    ...
    :cond_5
    iput-object p0, p1, Lcom/android/server/wm/WindowState;->mReplacingWindow:Lcom/android/server/wm/WindowState;
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wm/Task;->getDisplayContent()Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wm/Task;->isFloating()Z
    ...
    sget-boolean v41, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SAMSUNG_MULTIWINDOW_DYNAMIC_ENABLED:Z

    if-eqz v41, :cond_2

    sget-boolean v41, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_SLIDE_MODE:Z
    ...
    invoke-virtual/range {v41 .. v41}, Landroid/graphics/Rect;->setEmpty()V
    ...
    invoke-interface/range {v41 .. v42}, Lcom/samsung/android/view/IWindowStateBridge;->applyAspectRatio(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wm/Task;->isResizeableByDockedStack()Z
    ...
    invoke-virtual/range {v41 .. v42}, Landroid/graphics/Rect;->contains(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual/range {v41 .. v41}, Landroid/graphics/Rect;->isEmpty()Z
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/wm/WindowStateAnimator;->getShown()Z
    ...
    invoke-virtual/range {v41 .. v45}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/wm/DisplayContent;->getDockedDividerController()Lcom/android/server/wm/DockedStackDividerController;
    ...
    invoke-virtual/range {v41 .. v42}, Lcom/android/server/wm/DockedStackDividerController;->positionDockedStackedDivider(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v41 .. v42}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v41 .. v42}, Landroid/graphics/Rect;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual/range {v41 .. v43}, Landroid/graphics/Rect;->offset(II)V
    ...
    invoke-virtual/range {v41 .. v42}, Landroid/graphics/Rect;->scale(F)V
    ...
    invoke-static/range {v41 .. v42}, Lcom/android/server/DssController$Tools;->applyScaleToCompatFrame(Landroid/graphics/Rect;F)V
    ...
    invoke-interface/range {v41 .. v41}, Lcom/samsung/android/view/IWindowStateBridge;->configureReducedScreenSpec()V
    ...
    :cond_12
    sget-boolean v41, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_LAYOUT:Z

    if-nez v41, :cond_13

    sget-boolean v41, Lcom/android/server/wm/WindowManagerService;->localLOGV:Z

    if-eqz v41, :cond_14

    :cond_13
    sget-object v41, Lcom/android/server/wm/WindowState;->TAG:Ljava/lang/String;

    new-instance v42, Ljava/lang/StringBuilder;

    invoke-direct/range {v42 .. v42}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v43, "Resolving (mRequestedWidth="
    ...
    const-string/jumbo v43, ", mRequestedheight="
    ...
    const-string/jumbo v43, ") to"

    invoke-virtual/range {v42 .. v43}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v42

    const-string/jumbo v43, " (pw="
    ...
    invoke-virtual/range {v43 .. v43}, Landroid/graphics/Rect;->toShortString()Ljava/lang/String;
    ...
    invoke-virtual/range {v41 .. v41}, Ljava/util/ArrayDeque;->isEmpty()Z
    ...
    invoke-interface/range {v41 .. v41}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getCurrentInputMethodClient()Lcom/android/server/wm/WindowState;
    ...
    invoke-interface/range {v41 .. v42}, Landroid/view/WindowManagerPolicy;->getContentRectLw(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/wm/AppWindowToken;->findMainWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/wm/DockedStackDividerController;->isResizing()Z
    ...
    invoke-virtual/range {v41 .. v41}, Ljava/util/ArrayDeque;->peek()Ljava/lang/Object;
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/wm/WindowState;->getTask()Lcom/android/server/wm/Task;
    ...
    iget-object v0, v0, Lcom/android/server/wm/WindowState;->mSamsungPolicy:Lcom/android/server/policy/SamsungWindowManagerPolicy;

    move-object/from16 v42, v0

    invoke-interface/range {v42 .. v42}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getStatusBarHeight()I
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/wm/Task;->inDockedWorkspace()Z
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/wm/DisplayContent;->getDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/wm/DisplayContent;->getMultiWindowFocusedFrameController()Lcom/android/server/wm/IMultiWindowFocusedFramePolicy;
    ...
    invoke-interface/range {v43 .. v43}, Landroid/view/WindowManagerPolicy;->isStatusBarTransparent()Z
    ...
    invoke-virtual/range {v41 .. v42}, Lcom/android/server/wm/DockedStackDividerController;->positionDividerPanel(Landroid/graphics/Rect;)V
    ...
    :cond_46
    sget-boolean v41, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SNAP_VIEW_SUPPORT:Z
    ...
    invoke-virtual/range {v41 .. v42}, Lcom/android/server/wm/DisplayContent;->getLogicalDisplayRect(Landroid/graphics/Rect;)V
...
.method maybeRemoveReplacedWindow()V
    ...
    iget-boolean v5, v3, Lcom/android/server/wm/WindowState;->mWillReplaceWindow:Z

    if-eqz v5, :cond_5

    iget-object v5, v3, Lcom/android/server/wm/WindowState;->mReplacingWindow:Lcom/android/server/wm/WindowState;
    ...
    invoke-direct {p0, v3}, Lcom/android/server/wm/WindowState;->setReplacingWindowForChild(Lcom/android/server/wm/WindowState;)V
    ...
    sget-object v5, Lcom/android/server/wm/WindowState;->TAG:Ljava/lang/String;

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "Removing replaced window: "
    ...
    :cond_2
    invoke-virtual {v3}, Lcom/android/server/wm/WindowState;->isDimming()Z

    move-result v5

    if-eqz v5, :cond_3

    invoke-virtual {v3}, Lcom/android/server/wm/WindowState;->transferDimToReplacement()V

    :cond_3
    iput-boolean v4, v3, Lcom/android/server/wm/WindowState;->mWillReplaceWindow:Z

    iget-boolean v0, v3, Lcom/android/server/wm/WindowState;->mAnimateReplacingWindow:Z

    iput-boolean v4, v3, Lcom/android/server/wm/WindowState;->mAnimateReplacingWindow:Z

    iput-boolean v4, v3, Lcom/android/server/wm/WindowState;->mReplacingRemoveRequested:Z

    iput-object v8, v3, Lcom/android/server/wm/WindowState;->mReplacingWindow:Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v5, v3}, Lcom/android/server/wm/WindowManagerService;->removeWindowInnerLocked(Lcom/android/server/wm/WindowState;)V
