...
.method private getLaunchStack(Lcom/android/server/am/ActivityRecord;ILcom/android/server/am/TaskRecord;Landroid/app/ActivityOptions;)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v8, v3, v9, v10}, Lcom/android/server/am/ActivityStackSupervisor;->getStack(IZZ)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v8, v9, v10, v11}, Lcom/android/server/am/ActivityStackSupervisor;->getStack(IZZ)Lcom/android/server/am/ActivityStack;
    ...
    const-string/jumbo v9, "com.samsung.android.sdk.multiwindow.freeform.launch_in_focusedstack"
    ...
    iget-object v8, p1, Lcom/android/server/am/ActivityRecord;->launchedFromPackage:Ljava/lang/String;
    ...
    iget v8, v5, Lcom/android/server/am/TaskRecord;->mHiddenState:I
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityStarter;->mSourceStack:Lcom/android/server/am/ActivityStack;
    ...
    iget v8, p3, Lcom/android/server/am/TaskRecord;->mHiddenState:I
    ...
    iget-object v4, p3, Lcom/android/server/am/TaskRecord;->stack:Lcom/android/server/am/ActivityStack;
    ...
    :cond_10
    iget-object v8, p1, Lcom/android/server/am/ActivityRecord;->mInitialActivityContainer:Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;

    if-eqz v8, :cond_11

    iget-object v8, p1, Lcom/android/server/am/ActivityRecord;->mInitialActivityContainer:Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;

    iget-object v4, v8, Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;->mStack:Lcom/android/server/am/ActivityStack;
    ...
    iget-object v4, v8, Lcom/android/server/am/ActivityStackSupervisor;->mFocusedStack:Lcom/android/server/am/ActivityStack;
...
.method private setTargetStackAndMoveToFrontIfNeeded(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    iget v10, v1, Lcom/android/server/am/ActivityStack;->mStackId:I
    ...
    iget-object v15, v1, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;
    ...
    iget-object v1, v15, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;
    ...
    iget-object v1, v15, Landroid/content/pm/ActivityInfo;->metaData:Landroid/os/Bundle;
    ...
    invoke-interface {v1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->minimizeAllTasksInFreeformLocked()V

    :cond_3
    if-eqz v9, :cond_5

    iget-object v1, v9, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    invoke-virtual {v11, v1}, Lcom/android/server/am/ActivityStack;->topRunningNonDelayedActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v15, v0, Lcom/android/server/am/ActivityStarter;->mNewTaskInfo:Landroid/content/pm/ActivityInfo;
    ...
    invoke-direct {v0, v1, v2, v11}, Lcom/android/server/am/ActivityStarter;->updateTaskReturnToType(Lcom/android/server/am/TaskRecord;ILcom/android/server/am/ActivityStack;)V
    ...
    :cond_13
    iget v1, v12, Lcom/android/server/am/ActivityStack;->mStackId:I
    ...
    const-string/jumbo v6, "hiddenFreeformMoveToFull"
