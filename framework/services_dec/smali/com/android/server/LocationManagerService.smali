...
.method private loadProvidersLocked()V
    ...
    new-instance v29, Lcom/android/server/location/PassiveProvider;
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/server/location/PassiveProvider;->getName()Ljava/lang/String;
    ...
    new-instance v26, Lcom/android/server/location/GnssLocationProvider;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/location/GnssLocationProvider;->getGnssSystemInfoProvider()Lcom/android/server/location/GnssLocationProvider$GnssSystemInfoProvider;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/location/GnssLocationProvider;->getGnssStatusProvider()Landroid/location/IGnssStatusProvider;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/location/GnssLocationProvider;->getNetInitiatedListener()Landroid/location/INetInitiatedListener;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/location/GnssLocationProvider;->getGnssMeasurementsProvider()Lcom/android/server/location/GnssMeasurementsProvider;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/location/GnssLocationProvider;->getGnssNavigationMessageProvider()Lcom/android/server/location/GnssNavigationMessageProvider;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/location/GnssLocationProvider;->getGpsGeofenceProxy()Landroid/location/IGpsGeofenceHardware;
    ...
    iget v2, v0, Lcom/android/server/LocationManagerService;->nsFlpFeatureLevel:I
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/server/location/LocationProviderProxy;->getName()Ljava/lang/String;
    ...
    invoke-static {v2, v4, v5, v7, v3}, Lcom/android/server/location/GeocoderProxy;->createAndBind(Landroid/content/Context;IIILandroid/os/Handler;)Lcom/android/server/location/GeocoderProxy;
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/location/FlpHardwareProvider;->getLocationHardware()Landroid/hardware/location/IFusedLocationHardware;
    ...
    invoke-static/range {v7 .. v12}, Lcom/android/server/location/FusedProxy;->createAndBind(Landroid/content/Context;Landroid/os/Handler;Landroid/hardware/location/IFusedLocationHardware;III)Lcom/android/server/location/FusedProxy;
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/location/FlpHardwareProvider;->getGeofenceHardware()Landroid/location/IFusedGeofenceHardware;
    ...
    invoke-static/range {v7 .. v13}, Lcom/android/server/location/GeofenceProxy;->createAndBind(Landroid/content/Context;IIILandroid/os/Handler;Landroid/location/IGpsGeofenceHardware;Landroid/location/IFusedGeofenceHardware;)Lcom/android/server/location/GeofenceProxy;
    ...
    invoke-static/range {v7 .. v13}, Lcom/android/server/location/ActivityRecognitionProxy;->createAndBind(Landroid/content/Context;Landroid/os/Handler;ZLandroid/hardware/location/ActivityRecognitionHardware;III)Lcom/android/server/location/ActivityRecognitionProxy;
    ...
    const-string/jumbo v5, "Location service needs a fused location provider"
    ...
    invoke-direct/range {v11 .. v20}, Lcom/android/internal/location/ProviderProperties;-><init>(ZZZZZZZII)V

    move-object/from16 v0, p0

    move-object/from16 v1, v27

    invoke-direct {v0, v1, v11}, Lcom/android/server/LocationManagerService;->addTestProviderLocked(Ljava/lang/String;Lcom/android/internal/location/ProviderProperties;)V
...
.method private loadProvidersLocked_nlpHub()V
    ...
    const-string/jumbo v3, "CscFeature_GPS_SupportApqOnly"
    ...
    iget-boolean v2, v0, Lcom/android/server/LocationManagerService;->nlpHubInstalled:Z
    ...
    new-instance v33, Lcom/android/server/location/PassiveProvider;
    ...
    invoke-virtual/range {v33 .. v33}, Lcom/android/server/location/PassiveProvider;->getName()Ljava/lang/String;
    ...
    new-instance v28, Lcom/android/server/location/GnssLocationProvider;
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/location/GnssLocationProvider;->getGnssSystemInfoProvider()Lcom/android/server/location/GnssLocationProvider$GnssSystemInfoProvider;
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/location/GnssLocationProvider;->getGnssStatusProvider()Landroid/location/IGnssStatusProvider;
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/location/GnssLocationProvider;->getNetInitiatedListener()Landroid/location/INetInitiatedListener;
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/location/GnssLocationProvider;->getGnssMeasurementsProvider()Lcom/android/server/location/GnssMeasurementsProvider;
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/location/GnssLocationProvider;->getGnssNavigationMessageProvider()Lcom/android/server/location/GnssNavigationMessageProvider;
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/location/GnssLocationProvider;->getGpsGeofenceProxy()Landroid/location/IGpsGeofenceHardware;
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->mNlpHubReadyMarker:Ljava/lang/String;
    ...
    iput-object v2, v0, Lcom/android/server/LocationManagerService;->mNlpHubScreenMarker:Ljava/lang/String;
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/location/LocationProviderProxy;->getName()Ljava/lang/String;
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/server/location/FlpHardwareProvider;->getLocationHardware()Landroid/hardware/location/IFusedLocationHardware;
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/server/location/FlpHardwareProvider;->getGeofenceHardware()Landroid/location/IFusedGeofenceHardware;
    ...
    const-string/jumbo v3, "no gms location provider found"
...
.method private updateProvidersLocked()V
    ...
    sput-boolean v7, Lcom/android/server/LocationManagerService;->gps_initflag:Z
