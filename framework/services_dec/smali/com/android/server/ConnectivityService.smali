...
.method private getdualImsRegiOperator()Z
    .locals 2
...
.method private isNetworkWithLinkPropertiesBlocked(Landroid/net/LinkProperties;IZ)Z
    ...
    :cond_1
    iget-object v8, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
...
.method private makeDefault(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/ConnectivityService;->setIpAddressType(Landroid/net/LinkProperties;I)V
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    iput-object v7, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    invoke-virtual {p2, v7}, Landroid/net/NetworkInfo;->setType(I)V
    ...
    const-string/jumbo v7, "roaming status changed, notifying NetworkStatsService"
    ...
    :cond_1
    const-string/jumbo v7, "ignoring duplicate network state non-change"
    ...
    iput-object v6, p0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "Update the connection status of VPN -> "
    ...
    iput-boolean v7, p0, Lcom/android/server/ConnectivityService;->mSendIntentForSUSPENDED:Z

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "2Gvoice suspended networkinfo : "
    ...
    iget v10, v7, Landroid/net/Network;->netId:I
    ...
    :goto_4
    invoke-interface {v9, v10, v8, v7}, Landroid/os/INetworkManagementService;->createVirtualNetwork(IZZ)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    :cond_7
    iget-boolean v7, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->everConnected:Z
    ...
    const-string/jumbo v7, "ril.ims_netid"
    ...
    const-string/jumbo v8, "ril.ims_netid was set to "
    ...
    const-string/jumbo v7, "ril.epdn_netid"
    ...
    const-string/jumbo v7, "ril.eims_netid"
    ...
    const-string/jumbo v8, "ril.epdn_netid was set to "
    ...
    invoke-direct {p0, p1, v7}, Lcom/android/server/ConnectivityService;->updateLinkProperties(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V
    ...
    invoke-direct {p0, p1, v7, v8}, Lcom/android/server/ConnectivityService;->updateSignalStrengthThresholds(Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;Landroid/net/NetworkRequest;)V
    ...
    invoke-direct {p0, p1, v7}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;)V
    ...
    iput-boolean v7, p0, Lcom/android/server/ConnectivityService;->mSendIntentForCONNECTED:Z

    const/4 v7, 0x1

    iput-boolean v7, p0, Lcom/android/server/ConnectivityService;->mSuspendCallBack:Z
    ...
    const-string/jumbo v8, "2Gvoice connected networkinfo : "
    ...
    const-string/jumbo v8, "isSuspendedToConnected : "
    ...
    invoke-virtual {v7, v10}, Landroid/net/NetworkCapabilities;->hasCapability(I)Z
    ...
    :goto_7
    invoke-interface {v8, v9, v7}, Landroid/os/INetworkManagementService;->createPhysicalNetwork(ILjava/lang/String;)V
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_0
    ...
    const-string/jumbo v8, "Error creating network "
    ...
    invoke-virtual {v7, p1}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->update(Lcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method public setAirplaneMode(Z)V
    ...
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->getdualImsRegiOperator()Z
    ...
    const-string/jumbo v5, "com.sec.android.internal.ims.FLIGHT_MODE"
