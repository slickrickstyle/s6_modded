...
.method static synthetic -get11(Lcom/android/server/MountService;)Landroid/os/DVFSHelper;
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/server/MountService;Ljava/lang/String;)Landroid/os/storage/VolumeInfo;
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/server/MountService;Ljava/lang/String;Z)Z
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/android/server/MountService;->hasDeviceRestriction(Ljava/lang/String;Z)Z
...
.method static synthetic -wrap2(Lcom/android/server/MountService;Landroid/os/storage/VolumeInfo;)Z
    .locals 1
...
.method static synthetic -wrap4(Lcom/android/server/MountService;Ljava/lang/String;I)Z
    .locals 1
...
.method static synthetic -wrap5(Lcom/android/server/MountService;)Z
    .locals 1
...
.method static synthetic -wrap6(Lcom/android/server/MountService;Z)V
    .locals 0
...
.method static synthetic -wrap7(Lcom/android/server/MountService;Lcom/android/server/MountService$ObbState;)V
    .locals 0
...
.method static synthetic -wrap9(Lcom/android/server/MountService;Ljava/lang/String;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v6, p0, Lcom/android/server/MountService;->mUsbStorageBooster:Landroid/os/DVFSHelper;
    ...
    iput-boolean v12, p0, Lcom/android/server/MountService;->preSDPolicy:Z
    ...
    iput-object v6, p0, Lcom/android/server/MountService;->mDem:Lcom/samsung/android/security/SemSdCardEncryption;
...
.method private hasDeviceRestriction(Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v6, "hasDeviceRestriction: "
    ...
    const-string/jumbo v6, " from_intent "
    ...
    invoke-direct {p0, p1, v4, v5, v6}, Lcom/android/server/MountService;->hasSecRestriction(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v4, v5, v9}, Lcom/android/server/MountService;->hasSecRestriction(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "storage_itpolicy"
    ...
    const-string/jumbo v5, "hasDeviceRestriction: DevicePolicyManager is NULL"
    ...
    :cond_2
    invoke-virtual {v2, v9}, Landroid/app/admin/DevicePolicyManager;->semGetAllowStorageCard(Landroid/content/ComponentName;)Z
    ...
    iget-boolean v4, p0, Lcom/android/server/MountService;->preSDPolicy:Z
    ...
    const-string/jumbo v6, "policy has restriction but not show noti "
    ...
    :cond_3
    iput-boolean v8, p0, Lcom/android/server/MountService;->preSDPolicy:Z
    ...
    const-string/jumbo v6, "policy has restriction "
    ...
    const-string/jumbo v5, "Send ACTION_SDCARD_ITPOLICY_TOAST_EVENT INTENT!!"

    invoke-static {v4, v5}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v3, Landroid/content/Intent;

    const-string/jumbo v4, "com.samsung.intent.action.SDCARD_ITPOLICY_TOAST_EVENT"
    ...
    iput-boolean v7, p0, Lcom/android/server/MountService;->preSDPolicy:Z
    ...
    :cond_6
    const-string/jumbo v4, "storage_kor_mdm"
    ...
    const-string/jumbo v4, "persist.sys.microsd_lock"
    ...
    const-string/jumbo v6, "externalstorage_lock_state = "
    ...
    const-string/jumbo v4, "microsd_lock.enabled"
    ...
    const-string/jumbo v5, "not define policy !!!"
...
.method private isMountDisallowed(Landroid/os/storage/VolumeInfo;)Z
    ...
    const-string/jumbo v11, "!!!Skip!!! mount request : encrypt_state="
    ...
    const-string/jumbo v11, ", decrypt_state="
    ...
    const-string/jumbo v11, "to protect sdcardfs"
    ...
    const-string/jumbo v10, "Encryption type is FBE"
    ...
    invoke-virtual {v6, v12}, Landroid/app/enterprise/RestrictionPolicy;->isUsbHostStorageAllowed(Z)Z
    ...
    invoke-direct {p0, v9, v13}, Lcom/android/server/MountService;->hasDeviceRestriction(Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v10, "Policy has restriction \'storage_kor_mdm\'; cannot mount volume."
...
.method private onEventLocked(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    :cond_0
    const-string/jumbo v33, "MountService"
...
.method private onUnlockUser(I)V
    ...
    iget-object v5, p0, Lcom/android/server/MountService;->physicalVolumeLatch:Ljava/util/concurrent/CountDownLatch;
...
.method private validateDeviceRestriction(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/MountService;->hasDeviceRestriction(Ljava/lang/String;Z)Z
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v20, "MountService"
    ...
    const-string/jumbo v18, "StorageVolumes:"
    ...
    const-string/jumbo v18, "Volumes:"
    ...
    const-string/jumbo v18, "Records:"
    ...
    check-cast v11, Landroid/os/storage/VolumeRecord;

    invoke-virtual {v11, v15}, Landroid/os/storage/VolumeRecord;->dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string/jumbo v20, "Primary storage UUID: "
    ...
    const-string/jumbo v20, "Force adoptable: "
    ...
    const-string/jumbo v20, "Local unlocked users: "
    ...
    const-string/jumbo v20, "System unlocked users: "
    ...
    const-string/jumbo v18, "mObbMounts:"
    ...
    invoke-virtual {v15, v12}, Lcom/android/internal/util/IndentingPrintWriter;->println(Ljava/lang/Object;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    const-string/jumbo v18, "mObbPathToStateMap:"
    ...
    const-string/jumbo v18, "mConnector:"
    ...
    const-string/jumbo v18, "mCryptConnector:"
    ...
    iget-object v0, v0, Lcom/android/server/MountService;->mCryptConnector:Lcom/android/server/NativeDaemonConnector;
    ...
    const-string/jumbo v18, "Last maintenance: "
...
.method public encryptExternalStorage(Z)I
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/MountService;->isDeviceEncrypting()Z
    ...
    const-string/jumbo v3, "Skip encryptExternalStorage if enc/decryption is in progress. Due to time-out."
    ...
    const-string/jumbo v3, "encrypting external storage..."

    invoke-static {v2, v3}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/MountService;->mDem:Lcom/samsung/android/security/SemSdCardEncryption;

    invoke-virtual {v2}, Lcom/samsung/android/security/SemSdCardEncryption;->getExternalSdPath()Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lcom/android/server/MountService;->findVolumeByIdOrThrow(Ljava/lang/String;)Landroid/os/storage/VolumeInfo;
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v0, v2, v3}, Lcom/android/server/MountService;->hasDeviceRestriction(Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v3, "Policy has restriction \'readonly_storage\'; readonly"
    ...
    :cond_2
    :try_start_1
    invoke-virtual/range {v19 .. v19}, Landroid/os/storage/VolumeInfo;->getState()I
    :try_end_1
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-direct {v0, v15}, Lcom/android/server/MountService;->findVolumeIdForPathOrThrow(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    move-object/from16 v0, p0

    invoke-direct {v0, v2}, Lcom/android/server/MountService;->findVolumeByIdOrThrow(Ljava/lang/String;)Landroid/os/storage/VolumeInfo;
    :try_end_2
    .catch Ljava/lang/IllegalArgumentException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    const-string/jumbo v3, "unexpected volume.. failed to encrypt external stroage"
    ...
    iget-object v2, v0, Lcom/android/server/MountService;->mCryptConnector:Lcom/android/server/NativeDaemonConnector;
    ...
    const-string/jumbo v5, "enable_external"

    const/4 v6, 0x0

    aput-object v5, v4, v6

    const-string/jumbo v5, "inplace"
    ...
    iget v5, v0, Landroid/os/storage/VolumeInfo;->mountFlags:I
    ...
    :goto_2
    invoke-virtual {v11}, Lcom/android/server/NativeDaemonEvent;->getMessage()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/MountService;->getClass()Ljava/lang/Class;
    ...
    const-string/jumbo v7, "External Storage encryption failed."
    ...
    invoke-virtual {v9}, Lcom/android/server/NativeDaemonConnectorException;->getCode()I
...
.method public fixPermissionsSecureContainer(Ljava/lang/String;ILjava/lang/String;)I
    ...
    const-string/jumbo v3, "fixperms"
...
.method public mkdirs(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v8}, Lcom/android/server/MountService;->findVolumeByIdOrThrow(Ljava/lang/String;)Landroid/os/storage/VolumeInfo;
...
.method public mount(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/MountService;->isMountDisallowed(Landroid/os/storage/VolumeInfo;)Z
    ...
    invoke-direct {p0, v6, v9}, Lcom/android/server/MountService;->hasDeviceRestriction(Ljava/lang/String;Z)Z
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/server/MountService;->mDem:Lcom/samsung/android/security/SemSdCardEncryption;
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/MountService;->requiredEncPolicyCheck(Ljava/lang/String;)Z
    ...
    iget-object v6, p0, Lcom/android/server/MountService;->mUsbStorageBooster:Landroid/os/DVFSHelper;
    ...
    const-string/jumbo v7, "mount:: LPM disable to boost usb-storage up until 100 sec"
    ...
    invoke-virtual {v6, v7}, Landroid/os/DVFSHelper;->acquire(I)V
    ...
    const-string/jumbo v7, "mount:: LPM enable after boosting usb-storage up"
    ...
    const-string/jumbo v7, "mount:: not Usb"
    ...
    const-string/jumbo v7, "mount:: vol.disk is NULL"
    ...
    const-string/jumbo v7, "mount:: not TYPE_PUBLIC"
    ...
    const-string/jumbo v7, "mount:: fail to setting LPM : mUsbStorageBooster is NULL"
...
.method public moveDumpstates()I
    ...
    const-string/jumbo v5, "movedump"
...
.method public onDaemonConnected()V
    ...
    iget-object v0, p0, Lcom/android/server/MountService;->mDem:Lcom/samsung/android/security/SemSdCardEncryption;
    ...
    iput-object v0, p0, Lcom/android/server/MountService;->mDem:Lcom/samsung/android/security/SemSdCardEncryption;
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/security/SemSdCardEncryption;->registerListener(Landroid/os/storage/IDirEncryptServiceListener;)V
...
.method public partitionPublic(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4, v5, v6, v7}, Lcom/android/server/MountService;->waitForLatch(Ljava/util/concurrent/CountDownLatch;Ljava/lang/String;J)V
    :try_end_3
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_3 .. :try_end_3} :catch_1
...
.method requiredEncPolicyCheck(Ljava/lang/String;)Z
    ...
    const-string/jumbo v5, "requiredEncPolicyCheck()"
    ...
    const-string/jumbo v5, "DevicePolicyManager is NULL"
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/server/MountService;->mDem:Lcom/samsung/android/security/SemSdCardEncryption;

    invoke-virtual {v4}, Lcom/samsung/android/security/SemSdCardEncryption;->getSdCardEncryptionPreferences()Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    ...
    invoke-virtual {v0, v7}, Landroid/app/admin/DevicePolicyManager;->semGetRequireStorageCardEncryption(Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v5, "set policy for mdm"
    ...
    invoke-direct {v1, v9, v4, p1}, Lcom/samsung/android/security/SemSdCardEncryptionPolicy;-><init>(IILjava/lang/String;)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/DirEncryptPrefs;->savePrefs(Lcom/samsung/android/security/SemSdCardEncryptionPolicy;)Z
    ...
    const-string/jumbo v6, "policy set is    : "
    ...
    const-string/jumbo v6, "policy uuid      : "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    invoke-virtual {v3}, Lcom/samsung/android/security/SemSdCardEncryptionPolicy;->getCurrentUUID()Ljava/lang/String;
    ...
    const-string/jumbo v6, "encryption state : "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    invoke-virtual {v3}, Lcom/samsung/android/security/SemSdCardEncryptionPolicy;->getEncryptState()I
    ...
    const-string/jumbo v6, "This SD card has encryption state : "
    ...
    const-string/jumbo v5, "This device has encryption policy"
