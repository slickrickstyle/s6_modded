...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/internal/app/IBatteryStats;Lcom/android/internal/app/IAppOpsService;Lcom/android/server/power/SuspendBlocker;Landroid/view/WindowManagerPolicy;)V
    ...
    iput-object v2, p0, Lcom/android/server/power/Notifier;->mPersona:Lcom/samsung/android/knox/SemPersonaManager;

    iput-object v2, p0, Lcom/android/server/power/Notifier;->mEdgeInternal:Lcom/samsung/android/edge/EdgeManagerInternal;
...
.method private onWakeLockForEdgeLighting(ILjava/lang/String;)V
    .locals 1
    ...
    invoke-virtual {v0, p2}, Lcom/samsung/android/edge/EdgeManagerInternal;->hideForWakeLock(Ljava/lang/String;)V
...
.method public onWakeLockReleased(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    sget-boolean v3, Lcom/samsung/android/edge/SemEdgeManager;->SUPPORT_EDGE_LIGHTING:Z
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/power/Notifier;->onWakeLockForEdgeLighting(ILjava/lang/String;)V
    ...
    invoke-virtual/range {v9 .. v16}, Lcom/android/internal/os/SelfHealingServiceInternal;->wakeLockReleased(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;)V
    ...
    invoke-interface {v3, v4, v5, v0, v1}, Lcom/android/internal/app/IAppOpsService;->finishOperation(Landroid/os/IBinder;IILjava/lang/String;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
