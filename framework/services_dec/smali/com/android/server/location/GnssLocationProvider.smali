...
# instance fields
.field private engine_only_mode:I
...
.method static synthetic -get10(Lcom/android/server/location/GnssLocationProvider;)Z
    .locals 1
...
.method static synthetic -get18(Lcom/android/server/location/GnssLocationProvider;)Z
    .locals 1
...
.method static synthetic -get21(Lcom/android/server/location/GnssLocationProvider;)Lcom/android/server/location/GnssLocationProvider$BackOff;
    .locals 1
...
.method static synthetic -get22(Lcom/android/server/location/GnssLocationProvider;)I
    .locals 1
...
.method static synthetic -set4(Lcom/android/server/location/GnssLocationProvider;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/location/GnssLocationProvider;->mWifiNetworkAvailable:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    iput v6, p0, Lcom/android/server/location/GnssLocationProvider;->engine_only_mode:I
    ...
    iput v10, p0, Lcom/android/server/location/GnssLocationProvider;->mInjectNtpTimePending:I

    iput v10, p0, Lcom/android/server/location/GnssLocationProvider;->mDownloadXtraDataPending:I
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/location/GnssLocationProvider;->init_GnssLocationPrivider_samsung(Landroid/content/Context;Ljava/util/Properties;)V
    ...
    const-string/jumbo v1, "com.sec.feature.nsflp"
    ...
    const-string/jumbo v2, "NS-FLP Feature available, nsFlpFeatureLevel = "
...
.method private changeEngineOnlyMode(I)Z
    ...
    iget v1, p0, Lcom/android/server/location/GnssLocationProvider;->engine_only_mode:I
    ...
    :cond_1
    iput p1, p0, Lcom/android/server/location/GnssLocationProvider;->engine_only_mode:I
    ...
    const-string/jumbo v2, "ENGINE_ONLY_MODE Enabled"
    ...
    const-string/jumbo v2, "ENGINE_ONLY_MODE Enabled, release wakelock"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_3
    invoke-direct {p0, v4, v3, v5}, Lcom/android/server/location/GnssLocationProvider;->sendMessage(IILjava/lang/Object;)V
    ...
    iget v2, p0, Lcom/android/server/location/GnssLocationProvider;->engine_only_mode:I
    ...
    invoke-virtual {p0, v1, v0, v2}, Lcom/android/server/location/GnssLocationProvider;->extension_sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;Z)Z
    ...
    const-string/jumbo v2, "ENGINE_ONLY_MODE Disabled, acquire wakelock because mNavigating == true"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_6
    invoke-direct {p0, v4, v6, v5}, Lcom/android/server/location/GnssLocationProvider;->sendMessage(IILjava/lang/Object;)V
    ...
    const-string/jumbo v2, "ENGINE_ONLY_MODE Disabled, release wakelock because mNavigating == false"
...
.method private handleEnable()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/server/location/GnssLocationProvider;->extension_ctcSetHandleEnable()V
...
.method private reloadGpsProperties(Landroid/content/Context;Ljava/util/Properties;)V
    ...
    sget-boolean v7, Lcom/android/server/location/GnssLocationProvider;->DEBUG:Z
    ...
    const-string/jumbo v9, "Reset GPS properties, previous size = "
    ...
    invoke-direct {p0, v4, p2}, Lcom/android/server/location/GnssLocationProvider;->loadPropertiesFromFile(Ljava/lang/String;Ljava/util/Properties;)Z
    ...
    const-string/jumbo v9, "GPS properties reloaded, size = "
    ...
    :cond_3
    const-string/jumbo v7, "C2K_HOST"

    invoke-virtual {p2, v7}, Ljava/util/Properties;->getProperty(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    iput-object v7, p0, Lcom/android/server/location/GnssLocationProvider;->mC2KServerHost:Ljava/lang/String;

    const-string/jumbo v7, "C2K_PORT"

    invoke-virtual {p2, v7}, Ljava/util/Properties;->getProperty(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iget-object v7, p0, Lcom/android/server/location/GnssLocationProvider;->mC2KServerHost:Ljava/lang/String;
    ...
    iput v7, p0, Lcom/android/server/location/GnssLocationProvider;->mC2KServerPort:I
    :try_end_0
    .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_0} :catch_0

    :cond_4
    :goto_0
    iget-object v7, p0, Lcom/android/server/location/GnssLocationProvider;->mProperties:Ljava/util/Properties;

    const-string/jumbo v8, "SUPL_ES"
...
.method private reportLocation(IDDDFFFJ)V
    ...
    invoke-virtual {p0, v4, v5, v0, v1}, Lcom/android/server/location/GnssLocationProvider;->extension_sendGpsTime(JJ)V
...
.method private reportStatus(I)V
    ...
    :cond_3
    invoke-direct {p0, v7, v5, v8}, Lcom/android/server/location/GnssLocationProvider;->sendMessage(IILjava/lang/Object;)V
    ...
    :cond_4
    invoke-direct {p0, v7, v6, v8}, Lcom/android/server/location/GnssLocationProvider;->sendMessage(IILjava/lang/Object;)V
...
.method private reportSvStatus()V
    ...
    iget-object v5, p0, Lcom/android/server/location/GnssLocationProvider;->mSvElevations:[F

    iget-object v6, p0, Lcom/android/server/location/GnssLocationProvider;->mSvAzimuths:[F

    move-object v2, p0

    move v7, v1

    invoke-virtual/range {v2 .. v7}, Lcom/android/server/location/GnssLocationProvider;->extension_printSvStatus([I[F[F[FI)V

    iget v0, p0, Lcom/android/server/location/GnssLocationProvider;->mStatus:I

    invoke-direct {p0, v0, v10}, Lcom/android/server/location/GnssLocationProvider;->updateStatus(II)V
    ...
    invoke-virtual {v0, v9, v2}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method private startNavigating(Z)V
    ...
    :cond_0
    iput v8, p0, Lcom/android/server/location/GnssLocationProvider;->mTimeToFirstFix:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/server/location/GnssLocationProvider;->mLastFixTime:J

    iput-boolean v9, p0, Lcom/android/server/location/GnssLocationProvider;->mStarted:Z

    iput-boolean v9, p0, Lcom/android/server/location/GnssLocationProvider_samsung;->mStarted:Z

    iput-boolean p1, p0, Lcom/android/server/location/GnssLocationProvider;->mSingleShot:Z

    iput v9, p0, Lcom/android/server/location/GnssLocationProvider;->mPositionMode:I
    ...
    iget-boolean v3, p0, Lcom/android/server/location/GnssLocationProvider;->mNetworkAvailable:Z

    iget-boolean v4, p0, Lcom/android/server/location/GnssLocationProvider;->mWifiNetworkAvailable:Z

    move-object v0, p0

    move v5, p1

    invoke-virtual/range {v0 .. v5}, Lcom/android/server/location/GnssLocationProvider;->extension_setStartNavigatingModes(ILandroid/net/ConnectivityManager;ZZZ)I
    ...
    iget v0, p0, Lcom/android/server/location/GnssLocationProvider;->engine_only_mode:I
    ...
    const-string/jumbo v2, "setting position_mode to "
    ...
    invoke-direct {p0, v0, v9, v1}, Lcom/android/server/location/GnssLocationProvider;->sendMessage(IILjava/lang/Object;)V
    ...
    :cond_7
    invoke-direct {p0, v9, v8}, Lcom/android/server/location/GnssLocationProvider;->updateStatus(II)V
...
.method public sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    const-string/jumbo v4, "Discard delete_aiding_data request. Not the SEC Test Mode"
    ...
    :cond_4
    const-string/jumbo v3, "engine_only_mode"
    ...
    invoke-direct {p0, v3}, Lcom/android/server/location/GnssLocationProvider;->changeEngineOnlyMode(I)Z
    ...
    :cond_5
    iget-boolean v3, p0, Lcom/android/server/location/GnssLocationProvider;->mEnabled:Z

    invoke-virtual {p0, p1, p2, v3}, Lcom/android/server/location/GnssLocationProvider;->extension_sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;Z)Z
