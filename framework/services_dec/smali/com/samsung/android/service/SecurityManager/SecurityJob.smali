...
.field private static final SEC_MANAGER_ERR_FACE_LOCK_ON:I = 0x1000
...
.method private checkDevicePolicy()I
    ...
    const-string/jumbo v11, "SEC_FLOATING_FEATURE_ACCESSIBILITY_SUPPORT_DIRECTION_LOCK"
    ...
    iget-object v10, p0, Lcom/samsung/android/service/SecurityManager/SecurityJob;->mLPU:Lcom/android/internal/widget/LockPatternUtils;

    invoke-static {}, Landroid/os/UserHandle;->myUserId()I

    move-result v11

    invoke-virtual {v10, v11}, Lcom/android/internal/widget/LockPatternUtils;->isLockDirectionEnabled(I)Z

    move-result v10

    if-eqz v10, :cond_3

    const-string/jumbo v10, "DIRECTION LOCK ON"

    invoke-static {v10}, Lcom/samsung/android/service/SecurityManager/Log;->i(Ljava/lang/String;)I
    ...
    const-string/jumbo v11, "Failed. maximumFailedPasswordsForWipe = "
    ...
    invoke-static {v10}, Lcom/samsung/android/service/SecurityManager/Log;->e(Ljava/lang/String;)I
    ...
    const-string/jumbo v10, "Failed. the screen is not locked by password"
    ...
    const-string/jumbo v11, "Failed. Recovery password policy has been set. isPasswordRecoverable = "
    ...
    const-string/jumbo v10, "Failed. PasswordHistoryLength has been set."
    ...
    const-string/jumbo v11, "Failed. RevocationCheckPolicy has not been set yet. isRevocationCheckEnabled = "
    ...
    iget-object v10, p0, Lcom/samsung/android/service/SecurityManager/SecurityJob;->mDPM:Landroid/app/admin/DevicePolicyManager;

    const/4 v11, 0x0

    invoke-virtual {v10, v11}, Landroid/app/admin/DevicePolicyManager;->semGetRequireStorageCardEncryption(Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v10, "ODE check SUCCESS"

    invoke-static {v10}, Lcom/samsung/android/service/SecurityManager/Log;->d(Ljava/lang/String;)I

    :goto_6
    return v9

    :cond_3
    const-string/jumbo v10, "DIRECTION LOCK OFF"
    ...
    :cond_4
    const-string/jumbo v10, "MaxPassword check SUCCESS"
    ...
    :cond_5
    const-string/jumbo v10, "ScreenLock check SUCCESS"
    ...
    :cond_6
    const-string/jumbo v10, "RecoveryPassword check SUCCESS"
    ...
    :cond_7
    const-string/jumbo v10, "PasswordHistoryLength check SUCCESS"
    ...
    :cond_8
    const-string/jumbo v10, "RevocationCheckPolicy check SUCCESS"
    ...
    const-string/jumbo v11, "Failed. ODE check = "
    ...
    :pswitch_0
    const-string/jumbo v10, "ENCRYPTED BOTH"
    ...
    :pswitch_1
    const-string/jumbo v10, "ENCRYPTED INTERNAL"
...
.method private getString(I)Ljava/lang/String;
    ...
    iget-object v13, v0, Lcom/samsung/android/service/SecurityManager/SecurityJob;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/samsung/android/service/SecurityManager/SecurityJob;->isExternalSDRemovable()Z
    ...
    iget-object v14, v0, Lcom/samsung/android/service/SecurityManager/SecurityJob;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v14, "Face Lock"
...
.method private performCCModePreProcess()I
    ...
    const-string/jumbo v2, "Failed. checkICD = "
    ...
    const-string/jumbo v2, "Integrity verification failed. checkICD = "
    ...
    invoke-direct {p0, v3, v1}, Lcom/samsung/android/service/SecurityManager/SecurityJob;->logForAudit(ILjava/lang/String;)V
    ...
    const-string/jumbo v2, "Failed. FipsStatus = "
    ...
    const-string/jumbo v2, "Getting fips status failed. res = "
    ...
    const-string/jumbo v2, "Failed. Boringssl self test = "
    ...
    const-string/jumbo v2, "Boringssl self-test failed. res = "
    ...
    :cond_2
    const-string/jumbo v1, "Boringssl self-test success"

    const/4 v2, 0x5

    invoke-direct {p0, v2, v1}, Lcom/samsung/android/service/SecurityManager/SecurityJob;->logForAudit(ILjava/lang/String;)V

    const-string/jumbo v1, "Pre Process OK."
...
.method private setCCMode(I)I
    ...
    invoke-direct {p0, v7, v6}, Lcom/samsung/android/service/SecurityManager/SecurityJob;->logForAudit(ILjava/lang/String;)V
    :try_end_0
...
.method public verifyVPN()I
    ...
    invoke-virtual {v1}, Lcom/samsung/android/service/SecurityManager/SecurityNativeJob;->verifyVPN()I
    ...
    const-string/jumbo v2, "Failed. verifyVPN = "
    ...
    const-string/jumbo v2, "VPN verification failed. verifyVPN = "
...
.method public verifyWPA()I
    ...
    invoke-virtual {v1}, Lcom/samsung/android/service/SecurityManager/SecurityNativeJob;->verifyWPA()I
    ...
    const-string/jumbo v2, "Failed. verifyWPA = "
    ...
    const-string/jumbo v2, "WPA verification failed. verifyWPA = "
