...
.method private addTab(Lcom/android/settings/TrustedCredentialsSettings$Tab;)V
    ...
    iget-object v9, p0, Lcom/android/settings/TrustedCredentialsSettings;->mUserManager:Landroid/os/UserManager;
    ...
    invoke-direct {v1, p0, p1, v9}, Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;-><init>(Lcom/android/settings/TrustedCredentialsSettings;Lcom/android/settings/TrustedCredentialsSettings$Tab;Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;)V
    ...
    invoke-virtual {v1, v3}, Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;->getChildAdapter(I)Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;
    ...
    invoke-virtual {v0, v8}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->setContainerViewId(I)V
    ...
    invoke-virtual {v1, v8}, Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;->getUserInfoByGroup(I)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v2, v9}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->setContainerViewId(I)V

    invoke-virtual {v2, v8}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->showHeader(Z)V

    invoke-virtual {v2}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->prepare()V

    invoke-virtual {v1, v7}, Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;->getChildAdapter(I)Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;

    move-result-object v6

    invoke-static {p1}, Lcom/android/settings/TrustedCredentialsSettings$Tab;->-get9(Lcom/android/settings/TrustedCredentialsSettings$Tab;)I

    move-result v9

    invoke-virtual {v6, v9}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->setContainerViewId(I)V

    invoke-virtual {v6, v8}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->showHeader(Z)V

    invoke-virtual {v6, v8}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->showDivider(Z)V

    invoke-virtual {v6}, Lcom/android/settings/TrustedCredentialsSettings$ChildAdapter;->prepare()V
    ...
    iget-object v8, p0, Lcom/android/settings/TrustedCredentialsSettings;->mTabHost:Landroid/widget/TabHost;
    ...
    invoke-virtual {v1, v8}, Lcom/android/settings/TrustedCredentialsSettings$GroupAdapter;->setExpandableListView(Landroid/widget/ExpandableListView;)V
