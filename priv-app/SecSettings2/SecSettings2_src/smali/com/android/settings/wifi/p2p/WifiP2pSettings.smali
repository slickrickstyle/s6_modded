...
.field private static mBixbyRuleExecuted:Z
...
.method static synthetic -get10(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/os/CountDownTimer;
    .locals 1
...
.method static synthetic -get12(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Z
    .locals 1
...
.method static synthetic -get13(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/hardware/motion/MRListener;
    .locals 1
...
.method static synthetic -get14()Landroid/hardware/motion/MotionRecognitionManager;
    .locals 1
...
.method static synthetic -get15(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/net/NetworkInfo;
    .locals 1
...
.method static synthetic -get16()Landroid/net/wifi/p2p/WifiP2pDeviceList;
    .locals 1
...
.method static synthetic -get17(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Z
    .locals 1
...
.method static synthetic -get18(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/os/CountDownTimer;
    .locals 1
...
.method static synthetic -get19(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/speech/tts/TextToSpeech;
    .locals 1
...
.method static synthetic -get20(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/net/wifi/p2p/WifiP2pManager;
    .locals 1
...
.method static synthetic -get4()Z
    ...
    sget-boolean v0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mBixbyRuleExecuted:Z
...
.method static synthetic -get6(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    .locals 1
...
.method static synthetic -get7()Landroid/net/wifi/p2p/WifiP2pGroup;
    .locals 1
...
.method static synthetic -get8(Lcom/android/settings/wifi/p2p/WifiP2pSettings;)Lcom/samsung/android/settings/bixby/EmSettingsManager;
    .locals 1
...
.method static constructor <clinit>()V
    ...
    sput-boolean v2, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mBixbyRuleExecuted:Z
...
.method private sendNlgAndResponse(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    sput-boolean v0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mBixbyRuleExecuted:Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    sput-object v4, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v4, "PEER_STATE"
    ...
    :cond_0
    iget-object v4, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mPeersGroup:Landroid/preference/PreferenceGroup;
    ...
    const-string/jumbo v4, "AUTO_FINISH"
    ...
    iput-boolean v4, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mAutoFinish:Z
    ...
    invoke-virtual {v4, v7}, Landroid/widget/ListView;->setForcedClick(Z)V
    ...
    iget-object v4, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mOnHierarchyChangeListener:Landroid/view/ViewGroup$OnHierarchyChangeListener;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    new-instance v6, Lcom/android/settings/wifi/p2p/WifiP2pSettings$6;
    ...
    invoke-direct/range {v6 .. v11}, Lcom/android/settings/wifi/p2p/WifiP2pSettings$6;-><init>(Lcom/android/settings/wifi/p2p/WifiP2pSettings;JJ)V
...
.method public onPause()V
    ...
    const-string/jumbo v5, "onPause - LCD on? "
    ...
    const-string/jumbo v4, "SAMSUNG_P2P"
    ...
    const-string/jumbo v3, "IS_INVITED"
    ...
    invoke-virtual {v3, v4, v7}, Landroid/net/wifi/p2p/WifiP2pManager;->stopPeerDiscovery(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/WifiP2pManager$ActionListener;)V
    ...
    sput-boolean v6, Lcom/samsung/android/settings/wifi/WifiStatusReceiver;->mIsForegroundWifiSubSettings:Z
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;

    const-string/jumbo v4, "WiFiDirectSettings"

    invoke-virtual {v3, v4}, Lcom/samsung/android/settings/bixby/EmSettingsManager;->clearEmService(Ljava/lang/Object;)V

    sput-object v7, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mBixbyDeviceName:Ljava/lang/String;

    sput-object v7, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mBixbyStateId:Ljava/lang/String;
    ...
    invoke-direct {p0, v6, v8}, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->setScanTimer(ZZ)V

    iget-object v3, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mWifiP2pManager:Landroid/net/wifi/p2p/WifiP2pManager;

    iget-object v4, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mChannel:Landroid/net/wifi/p2p/WifiP2pManager$Channel;

    invoke-virtual {v3, v4, v8}, Landroid/net/wifi/p2p/WifiP2pManager;->setStopfindTimer(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Z)V
...
.method public onPeersAvailable(Landroid/net/wifi/p2p/WifiP2pDeviceList;)V
    ...
    sget-boolean v2, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mBixbyRuleExecuted:Z
...
.method public onResume()V
    ...
    const-string/jumbo v4, "onResume(), mAutoFinish : "
    ...
    const-string/jumbo v4, ", p2p enabled : "
    ...
    const-string/jumbo v4, ", p2p connected : "
    ...
    :cond_6
    iget-object v2, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;

    invoke-virtual {p0}, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->getContext()Landroid/content/Context;

    move-result-object v3

    iget-object v4, p0, Lcom/android/settings/wifi/p2p/WifiP2pSettings;->mEmCallback:Lcom/samsung/android/settings/bixby/EmSettingsManager$IEmCallback;

    const-string/jumbo v5, "WiFiDirectSettings"
    ...
    const-string/jumbo v3, "IllegalStateException: Recursive entry to executePendingTransactions during calling finish method to close the fragment."
