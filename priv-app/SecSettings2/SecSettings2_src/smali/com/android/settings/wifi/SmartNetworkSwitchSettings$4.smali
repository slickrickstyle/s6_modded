...
.method constructor <init>(Lcom/android/settings/wifi/SmartNetworkSwitchSettings;Landroid/net/wifi/WifiConfiguration;Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;->val$mWifiConfiguration:Landroid/net/wifi/WifiConfiguration;

    iput-object p3, p0, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;->val$mContext:Landroid/content/Context;

    iput-object p4, p0, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;->val$networkId:Ljava/lang/String;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;->val$mWifiConfiguration:Landroid/net/wifi/WifiConfiguration;
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;->val$mContext:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;->val$networkId:Ljava/lang/String;
    ...
    new-instance v2, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4$1;

    iget-object v3, p0, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;->val$mWifiConfiguration:Landroid/net/wifi/WifiConfiguration;

    invoke-direct {v2, p0, v3}, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4$1;-><init>(Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;Landroid/net/wifi/WifiConfiguration;)V
    ...
    new-instance v2, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4$2;

    invoke-direct {v2, p0}, Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4$2;-><init>(Lcom/android/settings/wifi/SmartNetworkSwitchSettings$4;)V
