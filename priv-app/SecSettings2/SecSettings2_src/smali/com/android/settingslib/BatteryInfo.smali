...
.method public static getBatteryInfo(Landroid/content/Context;Landroid/content/Intent;Landroid/os/BatteryStats;JZ)Lcom/android/settingslib/BatteryInfo;
    ...
    sget v20, Lcom/android/settingslib/R$string;->power_discharging_duration_short:I
    ...
    :cond_1
    sget v20, Lcom/android/settingslib/R$string;->power_discharging_duration:I
    ...
    check-cast v9, Landroid/os/CustomFrequencyManager;

    invoke-virtual {v9, v12}, Landroid/os/CustomFrequencyManager;->getBatteryRemainingUsageTime(I)I
    ...
    invoke-static {v15, v0, v1}, Lcom/android/settingslib/Utils;->getBatteryStatus(Landroid/content/res/Resources;Landroid/content/Intent;Z)Ljava/lang/String;
    ...
    sget v14, Lcom/android/settingslib/R$string;->power_charging_duration_ac_short:I
    ...
    :cond_6
    sget v14, Lcom/android/settingslib/R$string;->power_charging_duration_ac:I
    ...
    sget v14, Lcom/android/settingslib/R$string;->power_charging_duration_usb_short:I

    goto :goto_3

    :cond_8
    sget v14, Lcom/android/settingslib/R$string;->power_charging_duration_usb:I
    ...
    sget v14, Lcom/android/settingslib/R$string;->power_charging_duration_wireless_short:I

    goto :goto_3

    :cond_a
    sget v14, Lcom/android/settingslib/R$string;->power_charging_duration_wireless:I
    ...
    sget v14, Lcom/android/settingslib/R$string;->power_charging_duration_short:I

    goto :goto_3

    :cond_c
    sget v14, Lcom/android/settingslib/R$string;->power_charging_duration:I
