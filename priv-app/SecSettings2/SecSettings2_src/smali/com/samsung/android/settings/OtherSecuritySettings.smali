...
.method public onResume()V
    ...
    invoke-virtual/range {v19 .. v20}, Landroid/app/admin/DevicePolicyManager;->semGetAllowUnsignedInstallationPackage(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual/range {v19 .. v20}, Landroid/app/admin/DevicePolicyManager;->semGetAllowUnsignedApp(Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v21, "isScreenPinningAllowedAsUser"
    ...
    invoke-virtual/range {v19 .. v20}, Lcom/samsung/android/settings/SettingsSwitchPreference;->setChecked(Z)V
    ...
    invoke-virtual/range {v19 .. v20}, Lcom/samsung/android/settings/SettingsSwitchPreference;->setEnabled(Z)V
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/internal/widget/LockPatternUtils;->getProfiles(I)Ljava/util/List;
    ...
    invoke-virtual/range {v19 .. v21}, Landroid/security/KeyStore;->isEmpty(II)Z
    ...
    const-string/jumbo v19, "content://com.sec.knox.provider/CertificatePolicy"

    const-string/jumbo v20, "isUserRemoveCertificatesAllowed"
    ...
    const-string/jumbo v19, "content://com.sec.knox.provider2/vpnPolicy"

    const-string/jumbo v20, "isUserChangeProfilesAllowed"
    ...
    :cond_4
    const-string/jumbo v19, "OtherSecuritySettings"

    const-string/jumbo v20, "onResume() UserChange(or Remove) has disallowed by IT admin."
    ...
    const-string/jumbo v19, "com.samsung.android.softsim.ServiceStatus"
    ...
    const-string/jumbo v21, "isPasswordVisibilityEnabled"
    ...
    const-string/jumbo v20, "onResume() showPassword has disabled because IT admin blocked."
    ...
    const-string/jumbo v19, "no_adjust_volume"
