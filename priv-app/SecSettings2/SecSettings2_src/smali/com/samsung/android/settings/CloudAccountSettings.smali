...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v3}, Lcom/samsung/android/settings/CloudAccountSettings;->addPreferencesFromResource(I)V
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/CloudAccountSettings;->mContext:Landroid/content/Context;

    invoke-static {v3}, Lcom/android/settings/Utils;->isEnabledJanskyService(Landroid/content/Context;)Z

    move-result v3

    if-nez v3, :cond_0

    const-string/jumbo v3, "jansky_settings"

    invoke-virtual {p0, v3}, Lcom/samsung/android/settings/CloudAccountSettings;->removePreference(Ljava/lang/String;)V

    const-string/jumbo v3, "cloud_category"

    invoke-virtual {p0, v3}, Lcom/samsung/android/settings/CloudAccountSettings;->removePreference(Ljava/lang/String;)V

    :cond_0
    const-string/jumbo v3, "smartswitch_preference"

    invoke-virtual {p0, v3}, Lcom/samsung/android/settings/CloudAccountSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v3

    check-cast v3, Landroid/preference/PreferenceScreen;

    iput-object v3, p0, Lcom/samsung/android/settings/CloudAccountSettings;->mSmartSwitch:Landroid/preference/PreferenceScreen;
    ...
    const-string/jumbo v3, "cloud_preference"

    invoke-virtual {p0, v3}, Lcom/samsung/android/settings/CloudAccountSettings;->removePreference(Ljava/lang/String;)V

    const-string/jumbo v3, "account_category"
    ...
    const-string/jumbo v3, "privacy_category"
    ...
    const-string/jumbo v3, "smartswitch_category"
    ...
    const-string/jumbo v3, "account_preference"
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/CloudAccountSettings;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;

    const-string/jumbo v3, "desktopmode"

    invoke-virtual {p0, v3}, Lcom/samsung/android/settings/CloudAccountSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/samsung/android/desktopmode/SemDesktopModeManager;

    iput-object v3, p0, Lcom/samsung/android/settings/CloudAccountSettings;->mDesktopModeManager:Lcom/samsung/android/desktopmode/SemDesktopModeManager;
