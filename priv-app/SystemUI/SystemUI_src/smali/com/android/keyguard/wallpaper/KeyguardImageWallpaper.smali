...
.method public loadBitmap(ILandroid/os/UserHandle;)Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper$LoaderResult;
    ...
    invoke-virtual {v10}, Lcom/android/keyguard/KnoxStateMonitor;->isMDMWallpaperEnabled()Z

    move-result v10

    if-eqz v10, :cond_3

    const-string/jumbo v9, "/data/system/enterprise/lso/lockscreen_wallpaper.jpg"

    new-instance v4, Ljava/io/File;

    invoke-direct {v4, v9}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    invoke-direct {p0, v9}, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper;->setMDMFileObserver(Ljava/lang/String;)V
    ...
    invoke-direct {v8, v10, v9}, Landroid/graphics/drawable/BitmapDrawable;-><init>(Landroid/content/res/Resources;Ljava/lang/String;)V
    ...
    const-string/jumbo v11, "load MDM wallpaper!"

    invoke-static {v10, v11}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    invoke-static {v7}, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper$LoaderResult;->success(Landroid/graphics/Bitmap;)Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper$LoaderResult;
    :try_end_0
    ...
    const-string/jumbo v11, "Can\'t load MDM wallpaper!"
    ...
    const-string/jumbo v11, "file problem!"
    ...
    :goto_1
    iget-object v10, p0, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper;->mWallpaperManager:Landroid/app/WallpaperManager;

    const/4 v11, 0x2

    invoke-virtual {v10, v11, v5}, Landroid/app/WallpaperManager;->getWallpaperFile(II)Landroid/os/ParcelFileDescriptor;

    move-result-object v3

    const/4 v10, 0x0

    iput-boolean v10, p0, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper;->mIsOperatorWallpaper:Z
    ...
    :goto_2
    iget-boolean v10, p0, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper;->mShouldEnableScreenRotation:Z

    if-nez v10, :cond_2

    invoke-direct {p0, v7}, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper;->cropBitmap(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0, v7}, Landroid/graphics/Bitmap;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v7}, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper;->setWhiteBgSettings(Landroid/graphics/Bitmap;)V
    ...
    :cond_3
    iget-object v10, p0, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper;->mFileObserver:Landroid/os/FileObserver;
    ...
    iput-object v11, p0, Lcom/android/keyguard/wallpaper/KeyguardImageWallpaper;->mFileObserver:Landroid/os/FileObserver;
    ...
    sget v11, Lcom/android/keyguard/R$drawable;->keyguard_default_wallpaper:I
    ...
    const-string/jumbo v11, "Can\'t decode file"
