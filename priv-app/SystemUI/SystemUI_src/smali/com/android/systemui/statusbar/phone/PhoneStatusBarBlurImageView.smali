.class public Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->RADIUS:I

    const/16 v0, 0x500

    sput v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->HIGH:I

    const/16 v0, 0x2d0

    sput v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->WIDHT:I

    const/high16 v0, 0x40f00000    # 7.5f

    sput v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->DIVIDE:F
    ...
    sput-object v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->wallpaperManager:Landroid/app/WallpaperManager;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->wallpaperManager:Landroid/app/WallpaperManager;

    invoke-virtual {v0}, Landroid/app/WallpaperManager;->getBitmap()Landroid/graphics/Bitmap;

    move-result-object v0

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->mBitmapIn:Landroid/graphics/Bitmap;

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->mBitmapOut:Landroid/graphics/Bitmap;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->mSr:Z
...
.method public actualiza_valores()V
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v1, "intensity_blur"

    invoke-static {v0, v1, v2}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v3

    sput v3, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->RADIUS:I

    const/16 v2, 0x80

    const-string/jumbo v1, "clarity_background_blur"
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->actualiza_valores()V

    invoke-super {p0, p1}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->onDraw(Landroid/graphics/Canvas;)V

    iget-boolean v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->mSr:Z

    if-nez v0, :cond_0

    sget v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->HIGH:I

    sget v1, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->WIDHT:I
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->mContext:Landroid/content/Context;

    sget v3, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->RADIUS:I

    sget v4, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->DIVIDE:F

    sget v5, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->ALPHA:I

    invoke-virtual/range {v0 .. v5}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->jFastblur(Landroid/content/Context;Landroid/graphics/Bitmap;IFI)Landroid/graphics/Bitmap;

    move-result-object v0

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->mBitmapOut:Landroid/graphics/Bitmap;

    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V
...
.method protected onVisibilityChanged(Landroid/view/View;I)V
    ...
    invoke-super {p0, p1, p2}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->onVisibilityChanged(Landroid/view/View;I)V
...
.method public renderScriptBlur(Landroid/graphics/Bitmap;IFI)Landroid/graphics/Bitmap;
    ...
    const-string v21, "setBlurImageBitmap take "
...
.method public setBlurImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    sget v0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->RADIUS:I

    sget v1, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->DIVIDE:F

    sget v2, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->ALPHA:I

    invoke-virtual {p0, p1, v0, v1, v2}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->setBlurImageBitmap(Landroid/graphics/Bitmap;IFI)V
...
.method public setBlurImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    sget v1, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->RADIUS:I

    sget v2, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->DIVIDE:F

    sget v3, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->ALPHA:I

    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->setBlurImageBitmap(Landroid/graphics/Bitmap;IFI)V
...
.method public setBlurImageDrawable(Landroid/graphics/drawable/Drawable;IFI)V
    ...
    const-string v1, "setBlurImageDrawable"
    ...
    invoke-virtual {p0, v0, p2, p3, p4}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->setBlurImageBitmap(Landroid/graphics/Bitmap;IFI)V
...
.method public setWallpaperAsImage()V
    ...
    const-string v1, "setWallpaperAsImage"
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/android/systemui/statusbar/phone/PhoneStatusBarBlurImageView;->setBlurImageDrawable(Landroid/graphics/drawable/Drawable;IFI)V
